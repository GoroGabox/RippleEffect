 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(B,j){var J=B.length;B.push(j);e:for(;0<J;){var fe=J-1>>>1,se=B[fe];if(0<r(se,j))B[fe]=j,B[J]=se,J=fe;else break e}}function n(B){return B.length===0?null:B[0]}function i(B){if(B.length===0)return null;var j=B[0],J=B.pop();if(J!==j){B[0]=J;e:for(var fe=0,se=B.length,Le=se>>>1;fe<Le;){var He=2*(fe+1)-1,Fe=B[He],Z=He+1,ae=B[Z];if(0>r(Fe,J))Z<se&&0>r(ae,Fe)?(B[fe]=ae,B[Z]=J,fe=Z):(B[fe]=Fe,B[He]=J,fe=He);else if(Z<se&&0>r(ae,J))B[fe]=ae,B[Z]=J,fe=Z;else break e}}return j}function r(B,j){var J=B.sortIndex-j.sortIndex;return J!==0?J:B.id-j.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],u=[],d=1,h=null,f=3,m=!1,_=!1,E=!1,g=typeof setTimeout=="function"?setTimeout:null,c=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function S(B){for(var j=n(u);j!==null;){if(j.callback===null)i(u);else if(j.startTime<=B)i(u),j.sortIndex=j.expirationTime,e(l,j);else break;j=n(u)}}function M(B){if(E=!1,S(B),!_)if(n(l)!==null)_=!0,W(C);else{var j=n(u);j!==null&&z(M,j.startTime-B)}}function C(B,j){_=!1,E&&(E=!1,c(x),x=-1),m=!0;var J=f;try{for(S(j),h=n(l);h!==null&&(!(h.expirationTime>j)||B&&!b());){var fe=h.callback;if(typeof fe=="function"){h.callback=null,f=h.priorityLevel;var se=fe(h.expirationTime<=j);j=t.unstable_now(),typeof se=="function"?h.callback=se:h===n(l)&&i(l),S(j)}else i(l);h=n(l)}if(h!==null)var Le=!0;else{var He=n(u);He!==null&&z(M,He.startTime-j),Le=!1}return Le}finally{h=null,f=J,m=!1}}var w=!1,A=null,x=-1,R=5,P=-1;function b(){return!(t.unstable_now()-P<R)}function k(){if(A!==null){var B=t.unstable_now();P=B;var j=!0;try{j=A(!0,B)}finally{j?q():(w=!1,A=null)}}else w=!1}var q;if(typeof p=="function")q=function(){p(k)};else if(typeof MessageChannel<"u"){var K=new MessageChannel,I=K.port2;K.port1.onmessage=k,q=function(){I.postMessage(null)}}else q=function(){g(k,0)};function W(B){A=B,w||(w=!0,q())}function z(B,j){x=g(function(){B(t.unstable_now())},j)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(B){B.callback=null},t.unstable_continueExecution=function(){_||m||(_=!0,W(C))},t.unstable_forceFrameRate=function(B){0>B||125<B?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<B?Math.floor(1e3/B):5},t.unstable_getCurrentPriorityLevel=function(){return f},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(B){switch(f){case 1:case 2:case 3:var j=3;break;default:j=f}var J=f;f=j;try{return B()}finally{f=J}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(B,j){switch(B){case 1:case 2:case 3:case 4:case 5:break;default:B=3}var J=f;f=B;try{return j()}finally{f=J}},t.unstable_scheduleCallback=function(B,j,J){var fe=t.unstable_now();switch(typeof J=="object"&&J!==null?(J=J.delay,J=typeof J=="number"&&0<J?fe+J:fe):J=fe,B){case 1:var se=-1;break;case 2:se=250;break;case 5:se=1073741823;break;case 4:se=1e4;break;default:se=5e3}return se=J+se,B={id:d++,callback:j,priorityLevel:B,startTime:J,expirationTime:se,sortIndex:-1},J>fe?(B.sortIndex=J,e(u,B),n(l)===null&&B===n(u)&&(E?(c(x),x=-1):E=!0,z(M,J-fe))):(B.sortIndex=se,e(l,B),_||m||(_=!0,W(C))),B},t.unstable_shouldYield=b,t.unstable_wrapCallback=function(B){var j=f;return function(){var J=f;f=j;try{return B.apply(this,arguments)}finally{f=J}}}})(Hm);Vm.exports=Hm;var i_=Vm.exports;/**
 * @license React
...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Ci,depthTest:!1,depthWrite:!1})}function p1(t,e,n){const i=new Float32Array(wr),r=new G(0,1,0);return new wn({name:"SphericalGaussianBlur",defines:{n:wr,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${t}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:i},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:r}},vertexShader:eu(),fragmentShader:`
...
`)+`
`+c);const S=p+g+o,M=p+c+a,C=dm(r,r.VERTEX_SHADER,S),w=dm(r,r.FRAGMENT_SHADER,M);r.attachShader(E,C),r.attachShader(E,w),n.index0AttributeName!==void 0?r.bindAttribLocation(E,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(E,0,"position"),r.linkProgram(E);function A(b){if(t.debug.checkShaderErrors){const k=r.getProgramInfoLog(E)||"",q=r.getShaderInfoLog(C)||"",K=r.getShaderInfoLog(w)||"",I=k.trim(),W=q.trim(),z=K.trim();let B=!0,j=!0;if(r.getProgramParameter(E,r.LINK_STATUS)===!1)if(B=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,E,C,w);else{const J=pm(r,C,"vertex"),fe=pm(r,w,"fragment");et("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(E,r.VALIDATE_STATUS)+`
...
}`,nw=[new G(1,0,0),new G(-1,0,0),new G(0,1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1)],iw=[new G(0,-1,0),new G(0,-1,0),new G(0,0,1),new G(0,0,-1),new G(0,-1,0),new G(0,-1,0)],Mm=new Ft,ao=new G,lc=new G;function rw(t,e,n){let i=new pv;const r=new nt,s=new nt,o=new Pt,a=new _y,l=new xy,u={},d=n.maxTextureSize,h={[dr]:hn,[hn]:dr,[Mi]:Mi},f=new wn({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new nt},radius:{value:4}},vertexShader:ew,fragmentShader:tw}),m=f.clone();m.defines.HORIZONTAL_PASS=1;const _=new Fi;_.setAttribute("position",new ci(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const E=new hi(_,f),g=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Qa;let c=this.type;this.render=function(w,A,x){if(g.enabled===!1||g.autoUpdate===!1&&g.needsUpdate===!1||w.length===0)return;this.type===uS&&(ze("WebGLShadowMap: PCFSoftShadowMap has been deprecated. Using PCFShadowMap instead."),this.type=Qa);const R=t.getRenderTarget(),P=t.getActiveCubeFace(),b=t.getActiveMipmapLevel(),k=t.state;k.setBlending(Ci),k.buffers.depth.getReversed()===!0?k.buffers.color.setClear(0,0,0,0):k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const q=c!==this.type;q&&A.traverse(function(K){K.material&&(Array.isArray(K.material)?K.material.forEach(I=>I.needsUpdate=!0):K.material.needsUpdate=!0)});for(let K=0,I=w.length;K<I;K++){const W=w[K],z=W.shadow;if(z===void 0){ze("WebGLShadowMap:",W,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;r.copy(z.mapSize);const B=z.getFrameExtents();r.multiply(B),s.copy(z.mapSize),(r.x>d||r.y>d)&&(r.x>d&&(s.x=Math.floor(d/B.x),r.x=s.x*B.x,z.mapSize.x=s.x),r.y>d&&(s.y=Math.floor(d/B.y),r.y=s.y*B.y,z.mapSize.y=s.y));const j=t.state.buffers.depth.getReversed();if(z.camera._reversedDepth=j,z.map===null||q===!0){if(z.map!==null&&(z.map.depthTexture!==null&&(z.map.depthTexture.dispose(),z.map.depthTexture=null),z.map.dispose()),this.type===ho){if(W.isPointLight){ze("WebGLShadowMap: VSM shadow maps are not supported for PointLights. Use PCF or BasicShadowMap instead.");continue}z.map=new tn(r.x,r.y,{format:zr,type:di,minFilter:It,magFilter:It,generateMipmaps:!1}),z.map.texture.name=W.name+".shadowMap",z.map.depthTexture=new zs(r.x,r.y,si),z.map.depthTexture.name=W.name+".shadowMapDepth",z.map.depthTexture.format=Ui,z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Gt,z.map.depthTexture.magFilter=Gt}else W.isPointLight?(z.map=new yv(r.x),z.map.depthTexture=new dy(r.x,fi)):(z.map=new tn(r.x,r.y),z.map.depthTexture=new zs(r.x,r.y,fi)),z.map.depthTexture.name=W.name+".shadowMap",z.map.depthTexture.format=Ui,this.type===Qa?(z.map.depthTexture.compareFunction=j?Zd:Kd,z.map.depthTexture.minFilter=It,z.map.depthTexture.magFilter=It):(z.map.depthTexture.compareFunction=null,z.map.depthTexture.minFilter=Gt,z.map.depthTexture.magFilter=Gt);z.camera.updateProjectionMatrix()}const J=z.map.isWebGLCubeRenderTarget?6:1;for(let fe=0;fe<J;fe++){if(z.map.isWebGLCubeRenderTarget)t.setRenderTarget(z.map,fe),t.clear();else{fe===0&&(t.setRenderTarget(z.map),t.clear());const se=z.getViewport(fe);o.set(s.x*se.x,s.y*se.y,s.x*se.z,s.y*se.w),k.viewport(o)}if(W.isPointLight){const se=z.camera,Le=z.matrix,He=W.distance||se.far;He!==se.far&&(se.far=He,se.updateProjectionMatrix()),ao.setFromMatrixPosition(W.matrixWorld),se.position.copy(ao),lc.copy(se.position),lc.add(nw[fe]),se.up.copy(iw[fe]),se.lookAt(lc),se.updateMatrixWorld(),Le.makeTranslation(-ao.x,-ao.y,-ao.z),Mm.multiplyMatrices(se.projectionMatrix,se.matrixWorldInverse),z._frustum.setFromProjectionMatrix(Mm,se.coordinateSystem,se.reversedDepth)}else z.updateMatrices(W);i=z.getFrustum(),M(A,x,z.camera,W,this.type)}z.isPointLightShadow!==!0&&this.type===ho&&p(z,x),z.needsUpdate=!1}c=this.type,g.needsUpdate=!1,t.setRenderTarget(R,P,b)};function p(w,A){const x=e.update(E);f.defines.VSM_SAMPLES!==w.blurSamples&&(f.defines.VSM_SAMPLES=w.blurSamples,m.defines.VSM_SAMPLES=w.blurSamples,f.needsUpdate=!0,m.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new tn(r.x,r.y,{format:zr,type:di})),f.uniforms.shadow_pass.value=w.map.depthTexture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,t.setRenderTarget(w.mapPass),t.clear(),t.renderBufferDirect(A,null,x,f,E,null),m.uniforms.shadow_pass.value=w.mapPass.texture,m.uniforms.resolution.value=w.mapSize,m.uniforms.radius.value=w.radius,t.setRenderTarget(w.map),t.clear(),t.renderBufferDirect(A,null,x,m,E,null)}function S(w,A,x,R){let P=null;const b=x.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(b!==void 0)P=b;else if(P=x.isPointLight===!0?l:a,t.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const k=P.uuid,q=A.uuid;let K=u[k];K===void 0&&(K={},u[k]=K);let I=K[q];I===void 0&&(I=P.clone(),K[q]=I,A.addEventListener("dispose",C)),P=I}if(P.visible=A.visible,P.wireframe=A.wireframe,R===ho?P.side=A.shadowSide!==null?A.shadowSide:A.side:P.side=A.shadowSide!==null?A.shadowSide:h[A.side],P.alphaMap=A.alphaMap,P.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,P.map=A.map,P.clipShadows=A.clipShadows,P.clippingPlanes=A.clippingPlanes,P.clipIntersection=A.clipIntersection,P.displacementMap=A.displacementMap,P.displacementScale=A.displacementScale,P.displacementBias=A.displacementBias,P.wireframeLinewidth=A.wireframeLinewidth,P.linewidth=A.linewidth,x.isPointLight===!0&&P.isMeshDistanceMaterial===!0){const k=t.properties.get(P);k.light=x}return P}function M(w,A,x,R,P){if(w.visible===!1)return;if(w.layers.test(A.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&P===ho)&&(!w.frustumCulled||i.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(x.matrixWorldInverse,w.matrixWorld);const q=e.update(w),K=w.material;if(Array.isArray(K)){const I=q.groups;for(let W=0,z=I.length;W<z;W++){const B=I[W],j=K[B.materialIndex];if(j&&j.visible){const J=S(w,j,R,P);w.onBeforeShadow(t,w,A,x,q,J,B),t.renderBufferDirect(x,null,q,J,w,B),w.onAfterShadow(t,w,A,x,q,J,B)}}}else if(K.visible){const I=S(w,K,R,P);w.onBeforeShadow(t,w,A,x,q,I,null),t.renderBufferDirect(x,null,q,I,w,null),w.onAfterShadow(t,w,A,x,q,I,null)}}const k=w.children;for(let q=0,K=k.length;q<K;q++)M(k[q],A,x,R,P)}function C(w){w.target.removeEventListener("dispose",C);for(const x in u){const R=u[x],P=w.target.uuid;P in R&&(R[P].dispose(),delete R[P])}}}function sw(t,e){function n(){let D=!1;const ce=new Pt;let $=null;const pe=new Pt(0,0,0,0);return{setMask:function(he){$!==he&&!D&&(t.colorMask(he,he,he,he),$=he)},setLocked:function(he){D=he},setClear:function(he,ie,Ae,Ve,At){At===!0&&(he*=Ve,ie*=Ve,Ae*=Ve),ce.set(he,ie,Ae,Ve),pe.equals(ce)===!1&&(t.clearColor(he,ie,Ae,Ve),pe.copy(ce))},reset:function(){D=!1,$=null,pe.set(-1,0,0,0)}}}function i(){let D=!1,ce=!1,$=null,pe=null,he=null;return{setReversed:function(ie){if(ce!==ie){const Ae=e.get("EXT_clip_control");ie?Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.ZERO_TO_ONE_EXT):Ae.clipControlEXT(Ae.LOWER_LEFT_EXT,Ae.NEGATIVE_ONE_TO_ONE_EXT),ce=ie;const Ve=he;he=null,this.setClear(Ve)}},getReversed:function(){return ce},setTest:function(ie){ie?de(t.DEPTH_TEST):Ue(t.DEPTH_TEST)},setMask:function(ie){$!==ie&&!D&&(t.depthMask(ie),$=ie)},setFunc:function(ie){if(ce&&(ie=zS[ie]),pe!==ie){switch(ie){case sf:t.depthFunc(t.NEVER);break;case of:t.depthFunc(t.ALWAYS);break;case af:t.depthFunc(t.LESS);break;case Bs:t.depthFunc(t.LEQUAL);break;case lf:t.depthFunc(t.EQUAL);break;case uf:t.depthFunc(t.GEQUAL);break;case cf:t.depthFunc(t.GREATER);break;case ff:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}pe=ie}},setLocked:function(ie){D=ie},setClear:function(ie){he!==ie&&(he=ie,ce&&(ie=1-ie),t.clearDepth(ie))},reset:function(){D=!1,$=null,pe=null,he=null,ce=!1}}}function r(){let D=!1,ce=null,$=null,pe=null,he=null,ie=null,Ae=null,Ve=null,At=null;return{setTest:function(lt){D||(lt?de(t.STENCIL_TEST):Ue(t.STENCIL_TEST))},setMask:function(lt){ce!==lt&&!D&&(t.stencilMask(lt),ce=lt)},setFunc:function(lt,pi,Zn){($!==lt||pe!==pi||he!==Zn)&&(t.stencilFunc(lt,pi,Zn),$=lt,pe=pi,he=Zn)},setOp:function(lt,pi,Zn){(ie!==lt||Ae!==pi||Ve!==Zn)&&(t.stencilOp(lt,pi,Zn),ie=lt,Ae=pi,Ve=Zn)},setLocked:function(lt){D=lt},setClear:function(lt){At!==lt&&(t.clearStencil(lt),At=lt)},reset:function(){D=!1,ce=null,$=null,pe=null,he=null,ie=null,Ae=null,Ve=null,At=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,u=new WeakMap;let d={},h={},f={},m=new WeakMap,_=[],E=null,g=!1,c=null,p=null,S=null,M=null,C=null,w=null,A=null,x=new ct(0,0,0),R=0,P=!1,b=null,k=null,q=null,K=null,I=null;const W=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,B=0;const j=t.getParameter(t.VERSION);j.indexOf("WebGL")!==-1?(B=parseFloat(/^WebGL (\d)/.exec(j)[1]),z=B>=1):j.indexOf("OpenGL ES")!==-1&&(B=parseFloat(/^OpenGL ES (\d)/.exec(j)[1]),z=B>=2);let J=null,fe={};const se=t.getParameter(t.SCISSOR_BOX),Le=t.getParameter(t.VIEWPORT),He=new Pt().fromArray(se),Fe=new Pt().fromArray(Le);function Z(D,ce,$,pe){const he=new Uint8Array(4),ie=t.createTexture();t.bindTexture(D,ie),t.texParameteri(D,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(D,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Ae=0;Ae<$;Ae++)D===t.TEXTURE_3D||D===t.TEXTURE_2D_ARRAY?t.texImage3D(ce,0,t.RGBA,1,1,pe,0,t.RGBA,t.UNSIGNED_BYTE,he):t.texImage2D(ce+Ae,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,he);return ie}const ae={};ae[t.TEXTURE_2D]=Z(t.TEXTURE_2D,t.TEXTURE_2D,1),ae[t.TEXTURE_CUBE_MAP]=Z(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),ae[t.TEXTURE_2D_ARRAY]=Z(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),ae[t.TEXTURE_3D]=Z(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),de(t.DEPTH_TEST),o.setFunc(Bs),ft(!1),at(wp),de(t.CULL_FACE),Oe(Ci);function de(D){d[D]!==!0&&(t.enable(D),d[D]=!0)}function Ue(D){d[D]!==!1&&(t.disable(D),d[D]=!1)}function ke(D,ce){return f[D]!==ce?(t.bindFramebuffer(D,ce),f[D]=ce,D===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=ce),D===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=ce),!0):!1}function Ne(D,ce){let $=_,pe=!1;if(D){$=m.get(ce),$===void 0&&($=[],m.set(ce,$));const he=D.textures;if($.length!==he.length||$[0]!==t.COLOR_ATTACHMENT0){for(let ie=0,Ae=he.length;ie<Ae;ie++)$[ie]=t.COLOR_ATTACHMENT0+ie;$.length=he.length,pe=!0}}else $[0]!==t.BACK&&($[0]=t.BACK,pe=!0);pe&&t.drawBuffers($)}function it(D){return E!==D?(t.useProgram(D),E=D,!0):!1}const Xe={[Zi]:t.FUNC_ADD,[cS]:t.FUNC_SUBTRACT,[fS]:t.FUNC_REVERSE_SUBTRACT};Xe[dS]=t.MIN,Xe[hS]=t.MAX;const Ce={[pS]:t.ZERO,[W0]:t.ONE,[mS]:t.SRC_COLOR,[rf]:t.SRC_ALPHA,[yS]:t.SRC_ALPHA_SATURATE,[xS]:t.DST_COLOR,[vS]:t.DST_ALPHA,[gS]:t.ONE_MINUS_SRC_COLOR,[Rl]:t.ONE_MINUS_SRC_ALPHA,[SS]:t.ONE_MINUS_DST_COLOR,[_S]:t.ONE_MINUS_DST_ALPHA,[MS]:t.CONSTANT_COLOR,[ES]:t.ONE_MINUS_CONSTANT_COLOR,[TS]:t.CONSTANT_ALPHA,[wS]:t.ONE_MINUS_CONSTANT_ALPHA};function Oe(D,ce,$,pe,he,ie,Ae,Ve,At,lt){if(D===Ci){g===!0&&(Ue(t.BLEND),g=!1);return}if(g===!1&&(de(t.BLEND),g=!0),D!==G0){if(D!==c||lt!==P){if((p!==Zi||C!==Zi)&&(t.blendEquation(t.FUNC_ADD),p=Zi,C=Zi),lt)switch(D){case bs:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Ap:t.blendFunc(t.ONE,t.ONE);break;case Cp:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Rp:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:et("WebGLState: Invalid blending: ",D);break}else switch(D){case bs:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Ap:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case Cp:et("WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Rp:et("WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:et("WebGLState: Invalid blending: ",D);break}S=null,M=null,w=null,A=null,x.set(0,0,0),R=0,c=D,P=lt}return}he=he||ce,ie=ie||$,Ae=Ae||pe,(ce!==p||he!==C)&&(t.blendEquationSeparate(Xe[ce],Xe[he]),p=ce,C=he),($!==S||pe!==M||ie!==w||Ae!==A)&&(t.blendFuncSeparate(Ce[$],Ce[pe],Ce[ie],Ce[Ae]),S=$,M=pe,w=ie,A=Ae),(Ve.equals(x)===!1||At!==R)&&(t.blendColor(Ve.r,Ve.g,Ve.b,At),x.copy(Ve),R=At),c=D,P=!1}function Se(D,ce){D.side===Mi?Ue(t.CULL_FACE):de(t.CULL_FACE);let $=D.side===hn;ce&&($=!$),ft($),D.blending===bs&&D.transparent===!1?Oe(Ci):Oe(D.blending,D.blendEquation,D.blendSrc,D.blendDst,D.blendEquationAlpha,D.blendSrcAlpha,D.blendDstAlpha,D.blendColor,D.blendAlpha,D.premultipliedAlpha),o.setFunc(D.depthFunc),o.setTest(D.depthTest),o.setMask(D.depthWrite),s.setMask(D.colorWrite);const pe=D.stencilWrite;a.setTest(pe),pe&&(a.setMask(D.stencilWriteMask),a.setFunc(D.stencilFunc,D.stencilRef,D.stencilFuncMask),a.setOp(D.stencilFail,D.stencilZFail,D.stencilZPass)),L(D.polygonOffset,D.polygonOffsetFactor,D.polygonOffsetUnits),D.alphaToCoverage===!0?de(t.SAMPLE_ALPHA_TO_COVERAGE):Ue(t.SAMPLE_ALPHA_TO_COVERAGE)}function ft(D){b!==D&&(D?t.frontFace(t.CW):t.frontFace(t.CCW),b=D)}function at(D){D!==aS?(de(t.CULL_FACE),D!==k&&(D===wp?t.cullFace(t.BACK):D===lS?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):Ue(t.CULL_FACE),k=D}function rt(D){D!==q&&(z&&t.lineWidth(D),q=D)}function L(D,ce,$){D?(de(t.POLYGON_OFFSET_FILL),(K!==ce||I!==$)&&(K=ce,I=$,o.getReversed()&&(ce=-ce),t.polygonOffset(ce,$))):Ue(t.POLYGON_OFFSET_FILL)}function mt(D){D?de(t.SCISSOR_TEST):Ue(t.SCISSOR_TEST)}function Be(D){D===void 0&&(D=t.TEXTURE0+W-1),J!==D&&(t.activeTexture(D),J=D)}function $e(D,ce,$){$===void 0&&(J===null?$=t.TEXTURE0+W-1:$=J);let pe=fe[$];pe===void 0&&(pe={type:void 0,texture:void 0},fe[$]=pe),(pe.type!==D||pe.texture!==ce)&&(J!==$&&(t.activeTexture($),J=$),t.bindTexture(D,ce||ae[D]),pe.type=D,pe.texture=ce)}function me(){const D=fe[J];D!==void 0&&D.type!==void 0&&(t.bindTexture(D.type,null),D.type=void 0,D.texture=void 0)}function dt(){try{t.compressedTexImage2D(...arguments)}catch(D){et("WebGLState:",D)}}function T(){try{t.compressedTexImage3D(...arguments)}catch(D){et("WebGLState:",D)}}function v(){try{t.texSubImage2D(...arguments)}catch(D){et("WebGLState:",D)}}function O(){try{t.texSubImage3D(...arguments)}catch(D){et("WebGLState:",D)}}function Q(){try{t.compressedTexSubImage2D(...arguments)}catch(D){et("WebGLState:",D)}}function F(){try{t.compressedTexSubImage3D(...arguments)}catch(D){et("WebGLState:",D)}}function ne(){try{t.texStorage2D(...arguments)}catch(D){et("WebGLState:",D)}}function re(){try{t.texStorage3D(...arguments)}catch(D){et("WebGLState:",D)}}function Y(){try{t.texImage2D(...arguments)}catch(D){et("WebGLState:",D)}}function ee(){try{t.texImage3D(...arguments)}catch(D){et("WebGLState:",D)}}function ge(D){return h[D]!==void 0?h[D]:t.getParameter(D)}function ye(D,ce){h[D]!==ce&&(t.pixelStorei(D,ce),h[D]=ce)}function le(D){He.equals(D)===!1&&(t.scissor(D.x,D.y,D.z,D.w),He.copy(D))}function ue(D){Fe.equals(D)===!1&&(t.viewport(D.x,D.y,D.z,D.w),Fe.copy(D))}function Re(D,ce){let $=u.get(ce);$===void 0&&($=new WeakMap,u.set(ce,$));let pe=$.get(D);pe===void 0&&(pe=t.getUniformBlockIndex(ce,D.name),$.set(D,pe))}function Me(D,ce){const pe=u.get(ce).get(D);l.get(ce)!==pe&&(t.uniformBlockBinding(ce,pe,D.__bindingPointIndex),l.set(ce,pe))}function je(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),t.pixelStorei(t.PACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_ALIGNMENT,4),t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,!1),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,!1),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,t.BROWSER_DEFAULT_WEBGL),t.pixelStorei(t.PACK_ROW_LENGTH,0),t.pixelStorei(t.PACK_SKIP_PIXELS,0),t.pixelStorei(t.PACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_ROW_LENGTH,0),t.pixelStorei(t.UNPACK_IMAGE_HEIGHT,0),t.pixelStorei(t.UNPACK_SKIP_PIXELS,0),t.pixelStorei(t.UNPACK_SKIP_ROWS,0),t.pixelStorei(t.UNPACK_SKIP_IMAGES,0),d={},h={},J=null,fe={},f={},m=new WeakMap,_=[],E=null,g=!1,c=null,p=null,S=null,M=null,C=null,w=null,A=null,x=new ct(0,0,0),R=0,P=!1,b=null,k=null,q=null,K=null,I=null,He.set(0,0,t.canvas.width,t.canvas.height),Fe.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:de,disable:Ue,bindFramebuffer:ke,drawBuffers:Ne,useProgram:it,setBlending:Oe,setMaterial:Se,setFlipSided:ft,setCullFace:at,setLineWidth:rt,setPolygonOffset:L,setScissorTest:mt,activeTexture:Be,bindTexture:$e,unbindTexture:me,compressedTexImage2D:dt,compressedTexImage3D:T,texImage2D:Y,texImage3D:ee,pixelStorei:ye,getParameter:ge,updateUBOMapping:Re,uniformBlockBinding:Me,texStorage2D:ne,texStorage3D:re,texSubImage2D:v,texSubImage3D:O,compressedTexSubImage2D:Q,compressedTexSubImage3D:F,scissor:le,viewport:ue,reset:je}}function ow(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),u=new nt,d=new WeakMap,h=new Set;let f;const m=new WeakMap;let _=!1;try{_=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function E(T,v){return _?new OffscreenCanvas(T,v):Ul("canvas")}function g(T,v,O){let Q=1;const F=dt(T);if((F.width>O||F.height>O)&&(Q=O/Math.max(F.width,F.height)),Q<1)if(typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&T instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&T instanceof ImageBitmap||typeof VideoFrame<"u"&&T instanceof VideoFrame){const ne=Math.floor(Q*F.width),re=Math.floor(Q*F.height);f===void 0&&(f=E(ne,re));const Y=v?E(ne,re):f;return Y.width=ne,Y.height=re,Y.getContext("2d").drawImage(T,0,0,ne,re),ze("WebGLRenderer: Texture has been resized from ("+F.width+"x"+F.height+") to ("+ne+"x"+re+")."),Y}else return"data"in T&&ze("WebGLRenderer: Image in DataTexture is too big ("+F.width+"x"+F.height+")."),T;return T}function c(T){return T.generateMipmaps}function p(T){t.generateMipmap(T)}function S(T){return T.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:T.isWebGL3DRenderTarget?t.TEXTURE_3D:T.isWebGLArrayRenderTarget||T.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function M(T,v,O,Q,F,ne=!1){if(T!==null){if(t[T]!==void 0)return t[T];ze("WebGLRenderer: Attempt to use non-existing WebGL internal format '"+T+"'")}let re;Q&&(re=e.get("EXT_texture_norm16"),re||ze("WebGLRenderer: Unable to use normalized textures without EXT_texture_norm16 extension"));let Y=v;if(v===t.RED&&(O===t.FLOAT&&(Y=t.R32F),O===t.HALF_FLOAT&&(Y=t.R16F),O===t.UNSIGNED_BYTE&&(Y=t.R8),O===t.UNSIGNED_SHORT&&re&&(Y=re.R16_EXT),O===t.SHORT&&re&&(Y=re.R16_SNORM_EXT)),v===t.RED_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.R8UI),O===t.UNSIGNED_SHORT&&(Y=t.R16UI),O===t.UNSIGNED_INT&&(Y=t.R32UI),O===t.BYTE&&(Y=t.R8I),O===t.SHORT&&(Y=t.R16I),O===t.INT&&(Y=t.R32I)),v===t.RG&&(O===t.FLOAT&&(Y=t.RG32F),O===t.HALF_FLOAT&&(Y=t.RG16F),O===t.UNSIGNED_BYTE&&(Y=t.RG8),O===t.UNSIGNED_SHORT&&re&&(Y=re.RG16_EXT),O===t.SHORT&&re&&(Y=re.RG16_SNORM_EXT)),v===t.RG_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RG8UI),O===t.UNSIGNED_SHORT&&(Y=t.RG16UI),O===t.UNSIGNED_INT&&(Y=t.RG32UI),O===t.BYTE&&(Y=t.RG8I),O===t.SHORT&&(Y=t.RG16I),O===t.INT&&(Y=t.RG32I)),v===t.RGB_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RGB8UI),O===t.UNSIGNED_SHORT&&(Y=t.RGB16UI),O===t.UNSIGNED_INT&&(Y=t.RGB32UI),O===t.BYTE&&(Y=t.RGB8I),O===t.SHORT&&(Y=t.RGB16I),O===t.INT&&(Y=t.RGB32I)),v===t.RGBA_INTEGER&&(O===t.UNSIGNED_BYTE&&(Y=t.RGBA8UI),O===t.UNSIGNED_SHORT&&(Y=t.RGBA16UI),O===t.UNSIGNED_INT&&(Y=t.RGBA32UI),O===t.BYTE&&(Y=t.RGBA8I),O===t.SHORT&&(Y=t.RGBA16I),O===t.INT&&(Y=t.RGBA32I)),v===t.RGB&&(O===t.UNSIGNED_SHORT&&re&&(Y=re.RGB16_EXT),O===t.SHORT&&re&&(Y=re.RGB16_SNORM_EXT),O===t.UNSIGNED_INT_5_9_9_9_REV&&(Y=t.RGB9_E5),O===t.UNSIGNED_INT_10F_11F_11F_REV&&(Y=t.R11F_G11F_B10F)),v===t.RGBA){const ee=ne?Ll:Ze.getTransfer(F);O===t.FLOAT&&(Y=t.RGBA32F),O===t.HALF_FLOAT&&(Y=t.RGBA16F),O===t.UNSIGNED_BYTE&&(Y=ee===st?t.SRGB8_ALPHA8:t.RGBA8),O===t.UNSIGNED_SHORT&&re&&(Y=re.RGBA16_EXT),O===t.SHORT&&re&&(Y=re.RGBA16_SNORM_EXT),O===t.UNSIGNED_SHORT_4_4_4_4&&(Y=t.RGBA4),O===t.UNSIGNED_SHORT_5_5_5_1&&(Y=t.RGB5_A1)}return(Y===t.R16F||Y===t.R32F||Y===t.RG16F||Y===t.RG32F||Y===t.RGBA16F||Y===t.RGBA32F)&&e.get("EXT_color_buffer_float"),Y}function C(T,v){let O;return T?v===null||v===fi||v===Ho?O=t.DEPTH24_STENCIL8:v===si?O=t.DEPTH32F_STENCIL8:v===Vo&&(O=t.DEPTH24_STENCIL8,ze("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===fi||v===Ho?O=t.DEPTH_COMPONENT24:v===si?O=t.DEPTH_COMPONENT32F:v===Vo&&(O=t.DEPTH_COMPONENT16),O}function w(T,v){return c(T)===!0||T.isFramebufferTexture&&T.minFilter!==Gt&&T.minFilter!==It?Math.log2(Math.max(v.width,v.height))+1:T.mipmaps!==void 0&&T.mipmaps.length>0?T.mipmaps.length:T.isCompressedTexture&&Array.isArray(T.image)?v.mipmaps.length:1}function A(T){const v=T.target;v.removeEventListener("dispose",A),R(v),v.isVideoTexture&&d.delete(v),v.isHTMLTexture&&h.delete(v)}function x(T){const v=T.target;v.removeEventListener("dispose",x),b(v)}function R(T){const v=i.get(T);if(v.__webglInit===void 0)return;const O=T.source,Q=m.get(O);if(Q){const F=Q[v.__cacheKey];F.usedTimes--,F.usedTimes===0&&P(T),Object.keys(Q).length===0&&m.delete(O)}i.remove(T)}function P(T){const v=i.get(T);t.deleteTexture(v.__webglTexture);const O=T.source,Q=m.get(O);delete Q[v.__cacheKey],o.memory.textures--}function b(T){const v=i.get(T);if(T.depthTexture&&(T.depthTexture.dispose(),i.remove(T.depthTexture)),T.isWebGLCubeRenderTarget)for(let Q=0;Q<6;Q++){if(Array.isArray(v.__webglFramebuffer[Q]))for(let F=0;F<v.__webglFramebuffer[Q].length;F++)t.deleteFramebuffer(v.__webglFramebuffer[Q][F]);else t.deleteFramebuffer(v.__webglFramebuffer[Q]);v.__webglDepthbuffer&&t.deleteRenderbuffer(v.__webglDepthbuffer[Q])}else{if(Array.isArray(v.__webglFramebuffer))for(let Q=0;Q<v.__webglFramebuffer.length;Q++)t.deleteFramebuffer(v.__webglFramebuffer[Q]);else t.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&t.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&t.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let Q=0;Q<v.__webglColorRenderbuffer.length;Q++)v.__webglColorRenderbuffer[Q]&&t.deleteRenderbuffer(v.__webglColorRenderbuffer[Q]);v.__webglDepthRenderbuffer&&t.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const O=T.textures;for(let Q=0,F=O.length;Q<F;Q++){const ne=i.get(O[Q]);ne.__webglTexture&&(t.deleteTexture(ne.__webglTexture),o.memory.textures--),i.remove(O[Q])}i.remove(T)}let k=0;function q(){k=0}function K(){return k}function I(T){k=T}function W(){const T=k;return T>=r.maxTextures&&ze("WebGLTextures: Trying to use "+T+" texture units while this GPU supports only "+r.maxTextures),k+=1,T}function z(T){const v=[];return v.push(T.wrapS),v.push(T.wrapT),v.push(T.wrapR||0),v.push(T.magFilter),v.push(T.minFilter),v.push(T.anisotropy),v.push(T.internalFormat),v.push(T.format),v.push(T.type),v.push(T.generateMipmaps),v.push(T.premultiplyAlpha),v.push(T.flipY),v.push(T.unpackAlignment),v.push(T.colorSpace),v.join()}function B(T,v){const O=i.get(T);if(T.isVideoTexture&&$e(T),T.isRenderTargetTexture===!1&&T.isExternalTexture!==!0&&T.version>0&&O.__version!==T.version){const Q=T.image;if(Q===null)ze("WebGLRenderer: Texture marked for update but no image data found.");else if(Q.complete===!1)ze("WebGLRenderer: Texture marked for update but image is incomplete");else{Ue(O,T,v);return}}else T.isExternalTexture&&(O.__webglTexture=T.sourceTexture?T.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,O.__webglTexture,t.TEXTURE0+v)}function j(T,v){const O=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&O.__version!==T.version){Ue(O,T,v);return}else T.isExternalTexture&&(O.__webglTexture=T.sourceTexture?T.sourceTexture:null);n.bindTexture(t.TEXTURE_2D_ARRAY,O.__webglTexture,t.TEXTURE0+v)}function J(T,v){const O=i.get(T);if(T.isRenderTargetTexture===!1&&T.version>0&&O.__version!==T.version){Ue(O,T,v);return}n.bindTexture(t.TEXTURE_3D,O.__webglTexture,t.TEXTURE0+v)}function fe(T,v){const O=i.get(T);if(T.isCubeDepthTexture!==!0&&T.version>0&&O.__version!==T.version){ke(O,T,v);return}n.bindTexture(t.TEXTURE_CUBE_MAP,O.__webglTexture,t.TEXTURE0+v)}const se={[df]:t.REPEAT,[wi]:t.CLAMP_TO_EDGE,[hf]:t.MIRRORED_REPEAT},Le={[Gt]:t.NEAREST,[RS]:t.NEAREST_MIPMAP_NEAREST,[va]:t.NEAREST_MIPMAP_LINEAR,[It]:t.LINEAR,[Lu]:t.LINEAR_MIPMAP_NEAREST,[br]:t.LINEAR_MIPMAP_LINEAR},He={[DS]:t.NEVER,[FS]:t.ALWAYS,[LS]:t.LESS,[Kd]:t.LEQUAL,[IS]:t.EQUAL,[Zd]:t.GEQUAL,[US]:t.GREATER,[NS]:t.NOTEQUAL};function Fe(T,v){if(v.type===si&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===It||v.magFilter===Lu||v.magFilter===va||v.magFilter===br||v.minFilter===It||v.minFilter===Lu||v.minFilter===va||v.minFilter===br)&&ze("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(T,t.TEXTURE_WRAP_S,se[v.wrapS]),t.texParameteri(T,t.TEXTURE_WRAP_T,se[v.wrapT]),(T===t.TEXTURE_3D||T===t.TEXTURE_2D_ARRAY)&&t.texParameteri(T,t.TEXTURE_WRAP_R,se[v.wrapR]),t.texParameteri(T,t.TEXTURE_MAG_FILTER,Le[v.magFilter]),t.texParameteri(T,t.TEXTURE_MIN_FILTER,Le[v.minFilter]),v.compareFunction&&(t.texParameteri(T,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(T,t.TEXTURE_COMPARE_FUNC,He[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===Gt||v.minFilter!==va&&v.minFilter!==br||v.type===si&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||i.get(v).__currentAnisotropy){const O=e.get("EXT_texture_filter_anisotropic");t.texParameterf(T,O.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,r.getMaxAnisotropy())),i.get(v).__currentAnisotropy=v.anisotropy}}}function Z(T,v){let O=!1;T.__webglInit===void 0&&(T.__webglInit=!0,v.addEventListener("dispose",A));const Q=v.source;let F=m.get(Q);F===void 0&&(F={},m.set(Q,F));const ne=z(v);if(ne!==T.__cacheKey){F[ne]===void 0&&(F[ne]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,O=!0),F[ne].usedTimes++;const re=F[T.__cacheKey];re!==void 0&&(F[T.__cacheKey].usedTimes--,re.usedTimes===0&&P(v)),T.__cacheKey=ne,T.__webglTexture=F[ne].texture}return O}function ae(T,v,O){return Math.floor(Math.floor(T/O)/v)}function de(T,v,O,Q){const ne=T.updateRanges;if(ne.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,v.width,v.height,O,Q,v.data);else{ne.sort((ye,le)=>ye.start-le.start);let re=0;for(let ye=1;ye<ne.length;ye++){const le=ne[re],ue=ne[ye],Re=le.start+le.count,Me=ae(ue.start,v.width,4),je=ae(le.start,v.width,4);ue.start<=Re+1&&Me===je&&ae(ue.start+ue.count-1,v.width,4)===Me?le.count=Math.max(le.count,ue.start+ue.count-le.start):(++re,ne[re]=ue)}ne.length=re+1;const Y=n.getParameter(t.UNPACK_ROW_LENGTH),ee=n.getParameter(t.UNPACK_SKIP_PIXELS),ge=n.getParameter(t.UNPACK_SKIP_ROWS);n.pixelStorei(t.UNPACK_ROW_LENGTH,v.width);for(let ye=0,le=ne.length;ye<le;ye++){const ue=ne[ye],Re=Math.floor(ue.start/4),Me=Math.ceil(ue.count/4),je=Re%v.width,D=Math.floor(Re/v.width),ce=Me,$=1;n.pixelStorei(t.UNPACK_SKIP_PIXELS,je),n.pixelStorei(t.UNPACK_SKIP_ROWS,D),n.texSubImage2D(t.TEXTURE_2D,0,je,D,ce,$,O,Q,v.data)}T.clearUpdateRanges(),n.pixelStorei(t.UNPACK_ROW_LENGTH,Y),n.pixelStorei(t.UNPACK_SKIP_PIXELS,ee),n.pixelStorei(t.UNPACK_SKIP_ROWS,ge)}}function Ue(T,v,O){let Q=t.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(Q=t.TEXTURE_2D_ARRAY),v.isData3DTexture&&(Q=t.TEXTURE_3D);const F=Z(T,v),ne=v.source;n.bindTexture(Q,T.__webglTexture,t.TEXTURE0+O);const re=i.get(ne);if(ne.version!==re.__version||F===!0){if(n.activeTexture(t.TEXTURE0+O),(typeof ImageBitmap<"u"&&v.image instanceof ImageBitmap)===!1){const $=Ze.getPrimaries(Ze.workingColorSpace),pe=v.colorSpace===Qi?null:Ze.getPrimaries(v.colorSpace),he=v.colorSpace===Qi||$===pe?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,he)}n.pixelStorei(t.UNPACK_ALIGNMENT,v.unpackAlignment);let ee=g(v.image,!1,r.maxTextureSize);ee=me(v,ee);const ge=s.convert(v.format,v.colorSpace),ye=s.convert(v.type);let le=M(v.internalFormat,ge,ye,v.normalized,v.colorSpace,v.isVideoTexture);Fe(Q,v);let ue;const Re=v.mipmaps,Me=v.isVideoTexture!==!0,je=re.__version===void 0||F===!0,D=ne.dataReady,ce=w(v,ee);if(v.isDepthTexture)le=C(v.format===Pr,v.type),je&&(Me?n.texStorage2D(t.TEXTURE_2D,1,le,ee.width,ee.height):n.texImage2D(t.TEXTURE_2D,0,le,ee.width,ee.height,0,ge,ye,null));else if(v.isDataTexture)if(Re.length>0){Me&&je&&n.texStorage2D(t.TEXTURE_2D,ce,le,Re[0].width,Re[0].height);for(let $=0,pe=Re.length;$<pe;$++)ue=Re[$],Me?D&&n.texSubImage2D(t.TEXTURE_2D,$,0,0,ue.width,ue.height,ge,ye,ue.data):n.texImage2D(t.TEXTURE_2D,$,le,ue.width,ue.height,0,ge,ye,ue.data);v.generateMipmaps=!1}else Me?(je&&n.texStorage2D(t.TEXTURE_2D,ce,le,ee.width,ee.height),D&&de(v,ee,ge,ye)):n.texImage2D(t.TEXTURE_2D,0,le,ee.width,ee.height,0,ge,ye,ee.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){Me&&je&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ce,le,Re[0].width,Re[0].height,ee.depth);for(let $=0,pe=Re.length;$<pe;$++)if(ue=Re[$],v.format!==Mn)if(ge!==null)if(Me){if(D)if(v.layerUpdates.size>0){const he=Jp(ue.width,ue.height,v.format,v.type);for(const ie of v.layerUpdates){const Ae=ue.data.subarray(ie*he/ue.data.BYTES_PER_ELEMENT,(ie+1)*he/ue.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,$,0,0,ie,ue.width,ue.height,1,ge,Ae)}v.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,$,0,0,0,ue.width,ue.height,ee.depth,ge,ue.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,$,le,ue.width,ue.height,ee.depth,0,ue.data,0,0);else ze("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else Me?D&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,$,0,0,0,ue.width,ue.height,ee.depth,ge,ye,ue.data):n.texImage3D(t.TEXTURE_2D_ARRAY,$,le,ue.width,ue.height,ee.depth,0,ge,ye,ue.data)}else{Me&&je&&n.texStorage2D(t.TEXTURE_2D,ce,le,Re[0].width,Re[0].height);for(let $=0,pe=Re.length;$<pe;$++)ue=Re[$],v.format!==Mn?ge!==null?Me?D&&n.compressedTexSubImage2D(t.TEXTURE_2D,$,0,0,ue.width,ue.height,ge,ue.data):n.compressedTexImage2D(t.TEXTURE_2D,$,le,ue.width,ue.height,0,ue.data):ze("WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Me?D&&n.texSubImage2D(t.TEXTURE_2D,$,0,0,ue.width,ue.height,ge,ye,ue.data):n.texImage2D(t.TEXTURE_2D,$,le,ue.width,ue.height,0,ge,ye,ue.data)}else if(v.isDataArrayTexture)if(Me){if(je&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ce,le,ee.width,ee.height,ee.depth),D)if(v.layerUpdates.size>0){const $=Jp(ee.width,ee.height,v.format,v.type);for(const pe of v.layerUpdates){const he=ee.data.subarray(pe*$/ee.data.BYTES_PER_ELEMENT,(pe+1)*$/ee.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,pe,ee.width,ee.height,1,ge,ye,he)}v.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,ee.width,ee.height,ee.depth,ge,ye,ee.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,le,ee.width,ee.height,ee.depth,0,ge,ye,ee.data);else if(v.isData3DTexture)Me?(je&&n.texStorage3D(t.TEXTURE_3D,ce,le,ee.width,ee.height,ee.depth),D&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,ee.width,ee.height,ee.depth,ge,ye,ee.data)):n.texImage3D(t.TEXTURE_3D,0,le,ee.width,ee.height,ee.depth,0,ge,ye,ee.data);else if(v.isFramebufferTexture){if(je)if(Me)n.texStorage2D(t.TEXTURE_2D,ce,le,ee.width,ee.height);else{let $=ee.width,pe=ee.height;for(let he=0;he<ce;he++)n.texImage2D(t.TEXTURE_2D,he,le,$,pe,0,ge,ye,null),$>>=1,pe>>=1}}else if(v.isHTMLTexture){if("texElementImage2D"in t){const $=t.canvas;if($.hasAttribute("layoutsubtree")||$.setAttribute("layoutsubtree","true"),ee.parentNode!==$){$.appendChild(ee),h.add(v),$.onpaint=Ve=>{const At=Ve.changedElements;for(const lt of h)At.includes(lt.image)&&(lt.needsUpdate=!0)},$.requestPaint();return}const pe=0,he=t.RGBA,ie=t.RGBA,Ae=t.UNSIGNED_BYTE;t.texElementImage2D(t.TEXTURE_2D,pe,he,ie,Ae,ee),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_MIN_FILTER,t.LINEAR),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_S,t.CLAMP_TO_EDGE),t.texParameteri(t.TEXTURE_2D,t.TEXTURE_WRAP_T,t.CLAMP_TO_EDGE)}}else if(Re.length>0){if(Me&&je){const $=dt(Re[0]);n.texStorage2D(t.TEXTURE_2D,ce,le,$.width,$.height)}for(let $=0,pe=Re.length;$<pe;$++)ue=Re[$],Me?D&&n.texSubImage2D(t.TEXTURE_2D,$,0,0,ge,ye,ue):n.texImage2D(t.TEXTURE_2D,$,le,ge,ye,ue);v.generateMipmaps=!1}else if(Me){if(je){const $=dt(ee);n.texStorage2D(t.TEXTURE_2D,ce,le,$.width,$.height)}D&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,ge,ye,ee)}else n.texImage2D(t.TEXTURE_2D,0,le,ge,ye,ee);c(v)&&p(Q),re.__version=ne.version,v.onUpdate&&v.onUpdate(v)}T.__version=v.version}function ke(T,v,O){if(v.image.length!==6)return;const Q=Z(T,v),F=v.source;n.bindTexture(t.TEXTURE_CUBE_MAP,T.__webglTexture,t.TEXTURE0+O);const ne=i.get(F);if(F.version!==ne.__version||Q===!0){n.activeTexture(t.TEXTURE0+O);const re=Ze.getPrimaries(Ze.workingColorSpace),Y=v.colorSpace===Qi?null:Ze.getPrimaries(v.colorSpace),ee=v.colorSpace===Qi||re===Y?t.NONE:t.BROWSER_DEFAULT_WEBGL;n.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,v.flipY),n.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),n.pixelStorei(t.UNPACK_ALIGNMENT,v.unpackAlignment),n.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,ee);const ge=v.isCompressedTexture||v.image[0].isCompressedTexture,ye=v.image[0]&&v.image[0].isDataTexture,le=[];for(let ie=0;ie<6;ie++)!ge&&!ye?le[ie]=g(v.image[ie],!0,r.maxCubemapSize):le[ie]=ye?v.image[ie].image:v.image[ie],le[ie]=me(v,le[ie]);const ue=le[0],Re=s.convert(v.format,v.colorSpace),Me=s.convert(v.type),je=M(v.internalFormat,Re,Me,v.normalized,v.colorSpace),D=v.isVideoTexture!==!0,ce=ne.__version===void 0||Q===!0,$=F.dataReady;let pe=w(v,ue);Fe(t.TEXTURE_CUBE_MAP,v);let he;if(ge){D&&ce&&n.texStorage2D(t.TEXTURE_CUBE_MAP,pe,je,ue.width,ue.height);for(let ie=0;ie<6;ie++){he=le[ie].mipmaps;for(let Ae=0;Ae<he.length;Ae++){const Ve=he[Ae];v.format!==Mn?Re!==null?D?$&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae,0,0,Ve.width,Ve.height,Re,Ve.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae,je,Ve.width,Ve.height,0,Ve.data):ze("WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):D?$&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae,0,0,Ve.width,Ve.height,Re,Me,Ve.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae,je,Ve.width,Ve.height,0,Re,Me,Ve.data)}}}else{if(he=v.mipmaps,D&&ce){he.length>0&&pe++;const ie=dt(le[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,pe,je,ie.width,ie.height)}for(let ie=0;ie<6;ie++)if(ye){D?$&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,0,0,le[ie].width,le[ie].height,Re,Me,le[ie].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,je,le[ie].width,le[ie].height,0,Re,Me,le[ie].data);for(let Ae=0;Ae<he.length;Ae++){const At=he[Ae].image[ie].image;D?$&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae+1,0,0,At.width,At.height,Re,Me,At.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae+1,je,At.width,At.height,0,Re,Me,At.data)}}else{D?$&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,0,0,Re,Me,le[ie]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,0,je,Re,Me,le[ie]);for(let Ae=0;Ae<he.length;Ae++){const Ve=he[Ae];D?$&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae+1,0,0,Re,Me,Ve.image[ie]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ie,Ae+1,je,Re,Me,Ve.image[ie])}}}c(v)&&p(t.TEXTURE_CUBE_MAP),ne.__version=F.version,v.onUpdate&&v.onUpdate(v)}T.__version=v.version}function Ne(T,v,O,Q,F,ne){const re=s.convert(O.format,O.colorSpace),Y=s.convert(O.type),ee=M(O.internalFormat,re,Y,O.normalized,O.colorSpace),ge=i.get(v),ye=i.get(O);if(ye.__renderTarget=v,!ge.__hasExternalTextures){const le=Math.max(1,v.width>>ne),ue=Math.max(1,v.height>>ne);F===t.TEXTURE_3D||F===t.TEXTURE_2D_ARRAY?n.texImage3D(F,ne,ee,le,ue,v.depth,0,re,Y,null):n.texImage2D(F,ne,ee,le,ue,0,re,Y,null)}n.bindFramebuffer(t.FRAMEBUFFER,T),Be(v)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,Q,F,ye.__webglTexture,0,mt(v)):(F===t.TEXTURE_2D||F>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&F<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,Q,F,ye.__webglTexture,ne),n.bindFramebuffer(t.FRAMEBUFFER,null)}function it(T,v,O){if(t.bindRenderbuffer(t.RENDERBUFFER,T),v.depthBuffer){const Q=v.depthTexture,F=Q&&Q.isDepthTexture?Q.type:null,ne=C(v.stencilBuffer,F),re=v.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;Be(v)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,mt(v),ne,v.width,v.height):O?t.renderbufferStorageMultisample(t.RENDERBUFFER,mt(v),ne,v.width,v.height):t.renderbufferStorage(t.RENDERBUFFER,ne,v.width,v.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,re,t.RENDERBUFFER,T)}else{const Q=v.textures;for(let F=0;F<Q.length;F++){const ne=Q[F],re=s.convert(ne.format,ne.colorSpace),Y=s.convert(ne.type),ee=M(ne.internalFormat,re,Y,ne.normalized,ne.colorSpace);Be(v)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,mt(v),ee,v.width,v.height):O?t.renderbufferStorageMultisample(t.RENDERBUFFER,mt(v),ee,v.width,v.height):t.renderbufferStorage(t.RENDERBUFFER,ee,v.width,v.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function Xe(T,v,O){const Q=v.isWebGLCubeRenderTarget===!0;if(n.bindFramebuffer(t.FRAMEBUFFER,T),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const F=i.get(v.depthTexture);if(F.__renderTarget=v,(!F.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),Q){if(F.__webglInit===void 0&&(F.__webglInit=!0,v.depthTexture.addEventListener("dispose",A)),F.__webglTexture===void 0){F.__webglTexture=t.createTexture(),n.bindTexture(t.TEXTURE_CUBE_MAP,F.__webglTexture),Fe(t.TEXTURE_CUBE_MAP,v.depthTexture);const ge=s.convert(v.depthTexture.format),ye=s.convert(v.depthTexture.type);let le;v.depthTexture.format===Ui?le=t.DEPTH_COMPONENT24:v.depthTexture.format===Pr&&(le=t.DEPTH24_STENCIL8);for(let ue=0;ue<6;ue++)t.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+ue,0,le,v.width,v.height,0,ge,ye,null)}}else B(v.depthTexture,0);const ne=F.__webglTexture,re=mt(v),Y=Q?t.TEXTURE_CUBE_MAP_POSITIVE_X+O:t.TEXTURE_2D,ee=v.depthTexture.format===Pr?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;if(v.depthTexture.format===Ui)Be(v)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ee,Y,ne,0,re):t.framebufferTexture2D(t.FRAMEBUFFER,ee,Y,ne,0);else if(v.depthTexture.format===Pr)Be(v)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,ee,Y,ne,0,re):t.framebufferTexture2D(t.FRAMEBUFFER,ee,Y,ne,0);else throw new Error("Unknown depthTexture format")}function Ce(T){const v=i.get(T),O=T.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==T.depthTexture){const Q=T.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),Q){const F=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,Q.removeEventListener("dispose",F)};Q.addEventListener("dispose",F),v.__depthDisposeCallback=F}v.__boundDepthTexture=Q}if(T.depthTexture&&!v.__autoAllocateDepthBuffer)if(O)for(let Q=0;Q<6;Q++)Xe(v.__webglFramebuffer[Q],T,Q);else{const Q=T.texture.mipmaps;Q&&Q.length>0?Xe(v.__webglFramebuffer[0],T,0):Xe(v.__webglFramebuffer,T,0)}else if(O){v.__webglDepthbuffer=[];for(let Q=0;Q<6;Q++)if(n.bindFramebuffer(t.FRAMEBUFFER,v.__webglFramebuffer[Q]),v.__webglDepthbuffer[Q]===void 0)v.__webglDepthbuffer[Q]=t.createRenderbuffer(),it(v.__webglDepthbuffer[Q],T,!1);else{const F=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ne=v.__webglDepthbuffer[Q];t.bindRenderbuffer(t.RENDERBUFFER,ne),t.framebufferRenderbuffer(t.FRAMEBUFFER,F,t.RENDERBUFFER,ne)}}else{const Q=T.texture.mipmaps;if(Q&&Q.length>0?n.bindFramebuffer(t.FRAMEBUFFER,v.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=t.createRenderbuffer(),it(v.__webglDepthbuffer,T,!1);else{const F=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,ne=v.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,ne),t.framebufferRenderbuffer(t.FRAMEBUFFER,F,t.RENDERBUFFER,ne)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function Oe(T,v,O){const Q=i.get(T);v!==void 0&&Ne(Q.__webglFramebuffer,T,T.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),O!==void 0&&Ce(T)}function Se(T){const v=T.texture,O=i.get(T),Q=i.get(v);T.addEventListener("dispose",x);const F=T.textures,ne=T.isWebGLCubeRenderTarget===!0,re=F.length>1;if(re||(Q.__webglTexture===void 0&&(Q.__webglTexture=t.createTexture()),Q.__version=v.version,o.memory.textures++),ne){O.__webglFramebuffer=[];for(let Y=0;Y<6;Y++)if(v.mipmaps&&v.mipmaps.length>0){O.__webglFramebuffer[Y]=[];for(let ee=0;ee<v.mipmaps.length;ee++)O.__webglFramebuffer[Y][ee]=t.createFramebuffer()}else O.__webglFramebuffer[Y]=t.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){O.__webglFramebuffer=[];for(let Y=0;Y<v.mipmaps.length;Y++)O.__webglFramebuffer[Y]=t.createFramebuffer()}else O.__webglFramebuffer=t.createFramebuffer();if(re)for(let Y=0,ee=F.length;Y<ee;Y++){const ge=i.get(F[Y]);ge.__webglTexture===void 0&&(ge.__webglTexture=t.createTexture(),o.memory.textures++)}if(T.samples>0&&Be(T)===!1){O.__webglMultisampledFramebuffer=t.createFramebuffer(),O.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,O.__webglMultisampledFramebuffer);for(let Y=0;Y<F.length;Y++){const ee=F[Y];O.__webglColorRenderbuffer[Y]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,O.__webglColorRenderbuffer[Y]);const ge=s.convert(ee.format,ee.colorSpace),ye=s.convert(ee.type),le=M(ee.internalFormat,ge,ye,ee.normalized,ee.colorSpace,T.isXRRenderTarget===!0),ue=mt(T);t.renderbufferStorageMultisample(t.RENDERBUFFER,ue,le,T.width,T.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Y,t.RENDERBUFFER,O.__webglColorRenderbuffer[Y])}t.bindRenderbuffer(t.RENDERBUFFER,null),T.depthBuffer&&(O.__webglDepthRenderbuffer=t.createRenderbuffer(),it(O.__webglDepthRenderbuffer,T,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if(ne){n.bindTexture(t.TEXTURE_CUBE_MAP,Q.__webglTexture),Fe(t.TEXTURE_CUBE_MAP,v);for(let Y=0;Y<6;Y++)if(v.mipmaps&&v.mipmaps.length>0)for(let ee=0;ee<v.mipmaps.length;ee++)Ne(O.__webglFramebuffer[Y][ee],T,v,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Y,ee);else Ne(O.__webglFramebuffer[Y],T,v,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+Y,0);c(v)&&p(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(re){for(let Y=0,ee=F.length;Y<ee;Y++){const ge=F[Y],ye=i.get(ge);let le=t.TEXTURE_2D;(T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(le=T.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(le,ye.__webglTexture),Fe(le,ge),Ne(O.__webglFramebuffer,T,ge,t.COLOR_ATTACHMENT0+Y,le,0),c(ge)&&p(le)}n.unbindTexture()}else{let Y=t.TEXTURE_2D;if((T.isWebGL3DRenderTarget||T.isWebGLArrayRenderTarget)&&(Y=T.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(Y,Q.__webglTexture),Fe(Y,v),v.mipmaps&&v.mipmaps.length>0)for(let ee=0;ee<v.mipmaps.length;ee++)Ne(O.__webglFramebuffer[ee],T,v,t.COLOR_ATTACHMENT0,Y,ee);else Ne(O.__webglFramebuffer,T,v,t.COLOR_ATTACHMENT0,Y,0);c(v)&&p(Y),n.unbindTexture()}T.depthBuffer&&Ce(T)}function ft(T){const v=T.textures;for(let O=0,Q=v.length;O<Q;O++){const F=v[O];if(c(F)){const ne=S(T),re=i.get(F).__webglTexture;n.bindTexture(ne,re),p(ne),n.unbindTexture()}}}const at=[],rt=[];function L(T){if(T.samples>0){if(Be(T)===!1){const v=T.textures,O=T.width,Q=T.height;let F=t.COLOR_BUFFER_BIT;const ne=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,re=i.get(T),Y=v.length>1;if(Y)for(let ge=0;ge<v.length;ge++)n.bindFramebuffer(t.FRAMEBUFFER,re.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ge,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,re.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ge,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,re.__webglMultisampledFramebuffer);const ee=T.texture.mipmaps;ee&&ee.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,re.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,re.__webglFramebuffer);for(let ge=0;ge<v.length;ge++){if(T.resolveDepthBuffer&&(T.depthBuffer&&(F|=t.DEPTH_BUFFER_BIT),T.stencilBuffer&&T.resolveStencilBuffer&&(F|=t.STENCIL_BUFFER_BIT)),Y){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,re.__webglColorRenderbuffer[ge]);const ye=i.get(v[ge]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,ye,0)}t.blitFramebuffer(0,0,O,Q,0,0,O,Q,F,t.NEAREST),l===!0&&(at.length=0,rt.length=0,at.push(t.COLOR_ATTACHMENT0+ge),T.depthBuffer&&T.resolveDepthBuffer===!1&&(at.push(ne),rt.push(ne),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,rt)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,at))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),Y)for(let ge=0;ge<v.length;ge++){n.bindFramebuffer(t.FRAMEBUFFER,re.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+ge,t.RENDERBUFFER,re.__webglColorRenderbuffer[ge]);const ye=i.get(v[ge]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,re.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+ge,t.TEXTURE_2D,ye,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,re.__webglMultisampledFramebuffer)}else if(T.depthBuffer&&T.resolveDepthBuffer===!1&&l){const v=T.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[v])}}}function mt(T){return Math.min(r.maxSamples,T.samples)}function Be(T){const v=i.get(T);return T.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function $e(T){const v=o.render.frame;d.get(T)!==v&&(d.set(T,v),T.update())}function me(T,v){const O=T.colorSpace,Q=T.format,F=T.type;return T.isCompressedTexture===!0||T.isVideoTexture===!0||O!==Dl&&O!==Qi&&(Ze.getTransfer(O)===st?(Q!==Mn||F!==Sn)&&ze("WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):et("WebGLTextures: Unsupported texture color space:",O)),v}function dt(T){return typeof HTMLImageElement<"u"&&T instanceof HTMLImageElement?(u.width=T.naturalWidth||T.width,u.height=T.naturalHeight||T.height):typeof VideoFrame<"u"&&T instanceof VideoFrame?(u.width=T.displayWidth,u.height=T.displayHeight):(u.width=T.width,u.height=T.height),u}this.allocateTextureUnit=W,this.resetTextureUnits=q,this.getTextureUnits=K,this.setTextureUnits=I,this.setTexture2D=B,this.setTexture2DArray=j,this.setTexture3D=J,this.setTextureCube=fe,this.rebindTextures=Oe,this.setupRenderTarget=Se,this.updateRenderTargetMipmap=ft,this.updateMultisampleRenderTarget=L,this.setupDepthRenderbuffer=Ce,this.setupFrameBufferTexture=Ne,this.useMultisampledRTT=Be,this.isReversedDepthBuffer=function(){return n.buffers.depth.getReversed()}}function aw(t,e){function n(i,r=Qi){let s;const o=Ze.getTransfer(r);if(i===Sn)return t.UNSIGNED_BYTE;if(i===Xd)return t.UNSIGNED_SHORT_4_4_4_4;if(i===jd)return t.UNSIGNED_SHORT_5_5_5_1;if(i===nv)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===iv)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===ev)return t.BYTE;if(i===tv)return t.SHORT;if(i===Vo)return t.UNSIGNED_SHORT;if(i===Wd)return t.INT;if(i===fi)return t.UNSIGNED_INT;if(i===si)return t.FLOAT;if(i===di)return t.HALF_FLOAT;if(i===rv)return t.ALPHA;if(i===sv)return t.RGB;if(i===Mn)return t.RGBA;if(i===Ui)return t.DEPTH_COMPONENT;if(i===Pr)return t.DEPTH_STENCIL;if(i===ov)return t.RED;if(i===Yd)return t.RED_INTEGER;if(i===zr)return t.RG;if(i===qd)return t.RG_INTEGER;if(i===$d)return t.RGBA_INTEGER;if(i===Ja||i===el||i===tl||i===nl)if(o===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Ja)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===el)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===tl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===nl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Ja)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===el)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===tl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===nl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===pf||i===mf||i===gf||i===vf)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===pf)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===mf)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===gf)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===vf)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===_f||i===xf||i===Sf||i===yf||i===Mf||i===bl||i===Ef)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===_f||i===xf)return o===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===Sf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC;if(i===yf)return s.COMPRESSED_R11_EAC;if(i===Mf)return s.COMPRESSED_SIGNED_R11_EAC;if(i===bl)return s.COMPRESSED_RG11_EAC;if(i===Ef)return s.COMPRESSED_SIGNED_RG11_EAC}else return null;if(i===Tf||i===wf||i===Af||i===Cf||i===Rf||i===bf||i===Pf||i===Df||i===Lf||i===If||i===Uf||i===Nf||i===Ff||i===Of)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Tf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===wf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Af)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Cf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===Rf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===bf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Pf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Df)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===Lf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===If)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Uf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Nf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Ff)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===Of)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Bf||i===kf||i===zf)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Bf)return o===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===kf)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===zf)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Vf||i===Hf||i===Pl||i===Gf)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Vf)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Hf)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Pl)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Gf)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Ho?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const lw=`
void main() {
...
}`;class cw{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,n){if(this.texture===null){const i=new gv(e.texture);(e.depthNear!==n.depthNear||e.depthFar!==n.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=i}}getMesh(e){if(this.texture!==null&&this.mesh===null){const n=e.cameras[0].viewport,i=new wn({vertexShader:lw,fragmentShader:uw,uniforms:{depthColor:{value:this.texture},depthWidth:{value:n.z},depthHeight:{value:n.w}}});this.mesh=new hi(new Zo(20,20),i)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class fw extends Wr{constructor(e,n){super();const i=this;let r=null,s=1,o=null,a="local-floor",l=1,u=null,d=null,h=null,f=null,m=null,_=null;const E=typeof XRWebGLBinding<"u",g=new cw,c={},p=n.getContextAttributes();let S=null,M=null;const C=[],w=[],A=new nt;let x=null;const R=new jn;R.viewport=new Pt;const P=new jn;P.viewport=new Pt;const b=[R,P],k=new yy;let q=null,K=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let ae=C[Z];return ae===void 0&&(ae=new zu,C[Z]=ae),ae.getTargetRaySpace()},this.getControllerGrip=function(Z){let ae=C[Z];return ae===void 0&&(ae=new zu,C[Z]=ae),ae.getGripSpace()},this.getHand=function(Z){let ae=C[Z];return ae===void 0&&(ae=new zu,C[Z]=ae),ae.getHandSpace()};function I(Z){const ae=w.indexOf(Z.inputSource);if(ae===-1)return;const de=C[ae];de!==void 0&&(de.update(Z.inputSource,Z.frame,u||o),de.dispatchEvent({type:Z.type,data:Z.inputSource}))}function W(){r.removeEventListener("select",I),r.removeEventListener("selectstart",I),r.removeEventListener("selectend",I),r.removeEventListener("squeeze",I),r.removeEventListener("squeezestart",I),r.removeEventListener("squeezeend",I),r.removeEventListener("end",W),r.removeEventListener("inputsourceschange",z);for(let Z=0;Z<C.length;Z++){const ae=w[Z];ae!==null&&(w[Z]=null,C[Z].disconnect(ae))}q=null,K=null,g.reset();for(const Z in c)delete c[Z];e.setRenderTarget(S),m=null,f=null,h=null,r=null,M=null,Fe.stop(),i.isPresenting=!1,e.setPixelRatio(x),e.setSize(A.width,A.height,!1),i.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){s=Z,i.isPresenting===!0&&ze("WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){a=Z,i.isPresenting===!0&&ze("WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return u||o},this.setReferenceSpace=function(Z){u=Z},this.getBaseLayer=function(){return f!==null?f:m},this.getBinding=function(){return h===null&&E&&(h=new XRWebGLBinding(r,n)),h},this.getFrame=function(){return _},this.getSession=function(){return r},this.setSession=async function(Z){if(r=Z,r!==null){if(S=e.getRenderTarget(),r.addEventListener("select",I),r.addEventListener("selectstart",I),r.addEventListener("selectend",I),r.addEventListener("squeeze",I),r.addEventListener("squeezestart",I),r.addEventListener("squeezeend",I),r.addEventListener("end",W),r.addEventListener("inputsourceschange",z),p.xrCompatible!==!0&&await n.makeXRCompatible(),x=e.getPixelRatio(),e.getSize(A),E&&"createProjectionLayer"in XRWebGLBinding.prototype){let de=null,Ue=null,ke=null;p.depth&&(ke=p.stencil?n.DEPTH24_STENCIL8:n.DEPTH_COMPONENT24,de=p.stencil?Pr:Ui,Ue=p.stencil?Ho:fi);const Ne={colorFormat:n.RGBA8,depthFormat:ke,scaleFactor:s};h=this.getBinding(),f=h.createProjectionLayer(Ne),r.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),M=new tn(f.textureWidth,f.textureHeight,{format:Mn,type:Sn,depthTexture:new zs(f.textureWidth,f.textureHeight,Ue,void 0,void 0,void 0,void 0,void 0,void 0,de),stencilBuffer:p.stencil,colorSpace:e.outputColorSpace,samples:p.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const de={antialias:p.antialias,alpha:!0,depth:p.depth,stencil:p.stencil,framebufferScaleFactor:s};m=new XRWebGLLayer(r,n,de),r.updateRenderState({baseLayer:m}),e.setPixelRatio(1),e.setSize(m.framebufferWidth,m.framebufferHeight,!1),M=new tn(m.framebufferWidth,m.framebufferHeight,{format:Mn,type:Sn,colorSpace:e.outputColorSpace,stencilBuffer:p.stencil,resolveDepthBuffer:m.ignoreDepthValues===!1,resolveStencilBuffer:m.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(l),u=null,o=await r.requestReferenceSpace(a),Fe.setContext(r),Fe.start(),i.isPresenting=!0,i.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(r!==null)return r.environmentBlendMode},this.getDepthTexture=function(){return g.getDepthTexture()};function z(Z){for(let ae=0;ae<Z.removed.length;ae++){const de=Z.removed[ae],Ue=w.indexOf(de);Ue>=0&&(w[Ue]=null,C[Ue].disconnect(de))}for(let ae=0;ae<Z.added.length;ae++){const de=Z.added[ae];let Ue=w.indexOf(de);if(Ue===-1){for(let Ne=0;Ne<C.length;Ne++)if(Ne>=w.length){w.push(de),Ue=Ne;break}else if(w[Ne]===null){w[Ne]=de,Ue=Ne;break}if(Ue===-1)break}const ke=C[Ue];ke&&ke.connect(de)}}const B=new G,j=new G;function J(Z,ae,de){B.setFromMatrixPosition(ae.matrixWorld),j.setFromMatrixPosition(de.matrixWorld);const Ue=B.distanceTo(j),ke=ae.projectionMatrix.elements,Ne=de.projectionMatrix.elements,it=ke[14]/(ke[10]-1),Xe=ke[14]/(ke[10]+1),Ce=(ke[9]+1)/ke[5],Oe=(ke[9]-1)/ke[5],Se=(ke[8]-1)/ke[0],ft=(Ne[8]+1)/Ne[0],at=it*Se,rt=it*ft,L=Ue/(-Se+ft),mt=L*-Se;if(ae.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(mt),Z.translateZ(L),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),ke[10]===-1)Z.projectionMatrix.copy(ae.projectionMatrix),Z.projectionMatrixInverse.copy(ae.projectionMatrixInverse);else{const Be=it+L,$e=Xe+L,me=at-mt,dt=rt+(Ue-mt),T=Ce*Xe/$e*Be,v=Oe*Xe/$e*Be;Z.projectionMatrix.makePerspective(me,dt,T,v,Be,$e),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function fe(Z,ae){ae===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(ae.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(r===null)return;let ae=Z.near,de=Z.far;g.texture!==null&&(g.depthNear>0&&(ae=g.depthNear),g.depthFar>0&&(de=g.depthFar)),k.near=P.near=R.near=ae,k.far=P.far=R.far=de,(q!==k.near||K!==k.far)&&(r.updateRenderState({depthNear:k.near,depthFar:k.far}),q=k.near,K=k.far),k.layers.mask=Z.layers.mask|6,R.layers.mask=k.layers.mask&-5,P.layers.mask=k.layers.mask&-3;const Ue=Z.parent,ke=k.cameras;fe(k,Ue);for(let Ne=0;Ne<ke.length;Ne++)fe(ke[Ne],Ue);ke.length===2?J(k,R,P):k.projectionMatrix.copy(R.projectionMatrix),se(Z,k,Ue)};function se(Z,ae,de){de===null?Z.matrix.copy(ae.matrixWorld):(Z.matrix.copy(de.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(ae.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(ae.projectionMatrix),Z.projectionMatrixInverse.copy(ae.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=Xf*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return k},this.getFoveation=function(){if(!(f===null&&m===null))return l},this.setFoveation=function(Z){l=Z,f!==null&&(f.fixedFoveation=Z),m!==null&&m.fixedFoveation!==void 0&&(m.fixedFoveation=Z)},this.hasDepthSensing=function(){return g.texture!==null},this.getDepthSensingMesh=function(){return g.getMesh(k)},this.getCameraTexture=function(Z){return c[Z]};let Le=null;function He(Z,ae){if(d=ae.getViewerPose(u||o),_=ae,d!==null){const de=d.views;m!==null&&(e.setRenderTargetFramebuffer(M,m.framebuffer),e.setRenderTarget(M));let Ue=!1;de.length!==k.cameras.length&&(k.cameras.length=0,Ue=!0);for(let Xe=0;Xe<de.length;Xe++){const Ce=de[Xe];let Oe=null;if(m!==null)Oe=m.getViewport(Ce);else{const ft=h.getViewSubImage(f,Ce);Oe=ft.viewport,Xe===0&&(e.setRenderTargetTextures(M,ft.colorTexture,ft.depthStencilTexture),e.setRenderTarget(M))}let Se=b[Xe];Se===void 0&&(Se=new jn,Se.layers.enable(Xe),Se.viewport=new Pt,b[Xe]=Se),Se.matrix.fromArray(Ce.transform.matrix),Se.matrix.decompose(Se.position,Se.quaternion,Se.scale),Se.projectionMatrix.fromArray(Ce.projectionMatrix),Se.projectionMatrixInverse.copy(Se.projectionMatrix).invert(),Se.viewport.set(Oe.x,Oe.y,Oe.width,Oe.height),Xe===0&&(k.matrix.copy(Se.matrix),k.matrix.decompose(k.position,k.quaternion,k.scale)),Ue===!0&&k.cameras.push(Se)}const ke=r.enabledFeatures;if(ke&&ke.includes("depth-sensing")&&r.depthUsage=="gpu-optimized"&&E){h=i.getBinding();const Xe=h.getDepthInformation(de[0]);Xe&&Xe.isValid&&Xe.texture&&g.init(Xe,r.renderState)}if(ke&&ke.includes("camera-access")&&E){e.state.unbindTexture(),h=i.getBinding();for(let Xe=0;Xe<de.length;Xe++){const Ce=de[Xe].camera;if(Ce){let Oe=c[Ce];Oe||(Oe=new gv,c[Ce]=Oe);const Se=h.getCameraImage(Ce);Oe.sourceTexture=Se}}}}for(let de=0;de<C.length;de++){const Ue=w[de],ke=C[de];Ue!==null&&ke!==void 0&&ke.update(Ue,ae,u||o)}Le&&Le(Z,ae),ae.detectedPlanes&&i.dispatchEvent({type:"planesdetected",data:ae}),_=null}const Fe=new xv;Fe.setAnimationLoop(He),this.setAnimationLoop=function(Z){Le=Z},this.dispose=function(){}}}const dw=new Ft,Av=new Ge;Av.set(-1,0,0,0,1,0,0,0,1);function hw(t,e){function n(g,c){g.matrixAutoUpdate===!0&&g.updateMatrix(),c.value.copy(g.matrix)}function i(g,c){c.color.getRGB(g.fogColor.value,vv(t)),c.isFog?(g.fogNear.value=c.near,g.fogFar.value=c.far):c.isFogExp2&&(g.fogDensity.value=c.density)}function r(g,c,p,S,M){c.isNodeMaterial?c.uniformsNeedUpdate=!1:c.isMeshBasicMaterial?s(g,c):c.isMeshLambertMaterial?(s(g,c),c.envMap&&(g.envMapIntensity.value=c.envMapIntensity)):c.isMeshToonMaterial?(s(g,c),h(g,c)):c.isMeshPhongMaterial?(s(g,c),d(g,c),c.envMap&&(g.envMapIntensity.value=c.envMapIntensity)):c.isMeshStandardMaterial?(s(g,c),f(g,c),c.isMeshPhysicalMaterial&&m(g,c,M)):c.isMeshMatcapMaterial?(s(g,c),_(g,c)):c.isMeshDepthMaterial?s(g,c):c.isMeshDistanceMaterial?(s(g,c),E(g,c)):c.isMeshNormalMaterial?s(g,c):c.isLineBasicMaterial?(o(g,c),c.isLineDashedMaterial&&a(g,c)):c.isPointsMaterial?l(g,c,p,S):c.isSpriteMaterial?u(g,c):c.isShadowMaterial?(g.color.value.copy(c.color),g.opacity.value=c.opacity):c.isShaderMaterial&&(c.uniformsNeedUpdate=!1)}function s(g,c){g.opacity.value=c.opacity,c.color&&g.diffuse.value.copy(c.color),c.emissive&&g.emissive.value.copy(c.emissive).multiplyScalar(c.emissiveIntensity),c.map&&(g.map.value=c.map,n(c.map,g.mapTransform)),c.alphaMap&&(g.alphaMap.value=c.alphaMap,n(c.alphaMap,g.alphaMapTransform)),c.bumpMap&&(g.bumpMap.value=c.bumpMap,n(c.bumpMap,g.bumpMapTransform),g.bumpScale.value=c.bumpScale,c.side===hn&&(g.bumpScale.value*=-1)),c.normalMap&&(g.normalMap.value=c.normalMap,n(c.normalMap,g.normalMapTransform),g.normalScale.value.copy(c.normalScale),c.side===hn&&g.normalScale.value.negate()),c.displacementMap&&(g.displacementMap.value=c.displacementMap,n(c.displacementMap,g.displacementMapTransform),g.displacementScale.value=c.displacementScale,g.displacementBias.value=c.displacementBias),c.emissiveMap&&(g.emissiveMap.value=c.emissiveMap,n(c.emissiveMap,g.emissiveMapTransform)),c.specularMap&&(g.specularMap.value=c.specularMap,n(c.specularMap,g.specularMapTransform)),c.alphaTest>0&&(g.alphaTest.value=c.alphaTest);const p=e.get(c),S=p.envMap,M=p.envMapRotation;S&&(g.envMap.value=S,g.envMapRotation.value.setFromMatrix4(dw.makeRotationFromEuler(M)).transpose(),S.isCubeTexture&&S.isRenderTargetTexture===!1&&g.envMapRotation.value.premultiply(Av),g.reflectivity.value=c.reflectivity,g.ior.value=c.ior,g.refractionRatio.value=c.refractionRatio),c.lightMap&&(g.lightMap.value=c.lightMap,g.lightMapIntensity.value=c.lightMapIntensity,n(c.lightMap,g.lightMapTransform)),c.aoMap&&(g.aoMap.value=c.aoMap,g.aoMapIntensity.value=c.aoMapIntensity,n(c.aoMap,g.aoMapTransform))}function o(g,c){g.diffuse.value.copy(c.color),g.opacity.value=c.opacity,c.map&&(g.map.value=c.map,n(c.map,g.mapTransform))}function a(g,c){g.dashSize.value=c.dashSize,g.totalSize.value=c.dashSize+c.gapSize,g.scale.value=c.scale}function l(g,c,p,S){g.diffuse.value.copy(c.color),g.opacity.value=c.opacity,g.size.value=c.size*p,g.scale.value=S*.5,c.map&&(g.map.value=c.map,n(c.map,g.uvTransform)),c.alphaMap&&(g.alphaMap.value=c.alphaMap,n(c.alphaMap,g.alphaMapTransform)),c.alphaTest>0&&(g.alphaTest.value=c.alphaTest)}function u(g,c){g.diffuse.value.copy(c.color),g.opacity.value=c.opacity,g.rotation.value=c.rotation,c.map&&(g.map.value=c.map,n(c.map,g.mapTransform)),c.alphaMap&&(g.alphaMap.value=c.alphaMap,n(c.alphaMap,g.alphaMapTransform)),c.alphaTest>0&&(g.alphaTest.value=c.alphaTest)}function d(g,c){g.specular.value.copy(c.specular),g.shininess.value=Math.max(c.shininess,1e-4)}function h(g,c){c.gradientMap&&(g.gradientMap.value=c.gradientMap)}function f(g,c){g.metalness.value=c.metalness,c.metalnessMap&&(g.metalnessMap.value=c.metalnessMap,n(c.metalnessMap,g.metalnessMapTransform)),g.roughness.value=c.roughness,c.roughnessMap&&(g.roughnessMap.value=c.roughnessMap,n(c.roughnessMap,g.roughnessMapTransform)),c.envMap&&(g.envMapIntensity.value=c.envMapIntensity)}function m(g,c,p){g.ior.value=c.ior,c.sheen>0&&(g.sheenColor.value.copy(c.sheenColor).multiplyScalar(c.sheen),g.sheenRoughness.value=c.sheenRoughness,c.sheenColorMap&&(g.sheenColorMap.value=c.sheenColorMap,n(c.sheenColorMap,g.sheenColorMapTransform)),c.sheenRoughnessMap&&(g.sheenRoughnessMap.value=c.sheenRoughnessMap,n(c.sheenRoughnessMap,g.sheenRoughnessMapTransform))),c.clearcoat>0&&(g.clearcoat.value=c.clearcoat,g.clearcoatRoughness.value=c.clearcoatRoughness,c.clearcoatMap&&(g.clearcoatMap.value=c.clearcoatMap,n(c.clearcoatMap,g.clearcoatMapTransform)),c.clearcoatRoughnessMap&&(g.clearcoatRoughnessMap.value=c.clearcoatRoughnessMap,n(c.clearcoatRoughnessMap,g.clearcoatRoughnessMapTransform)),c.clearcoatNormalMap&&(g.clearcoatNormalMap.value=c.clearcoatNormalMap,n(c.clearcoatNormalMap,g.clearcoatNormalMapTransform),g.clearcoatNormalScale.value.copy(c.clearcoatNormalScale),c.side===hn&&g.clearcoatNormalScale.value.negate())),c.dispersion>0&&(g.dispersion.value=c.dispersion),c.iridescence>0&&(g.iridescence.value=c.iridescence,g.iridescenceIOR.value=c.iridescenceIOR,g.iridescenceThicknessMinimum.value=c.iridescenceThicknessRange[0],g.iridescenceThicknessMaximum.value=c.iridescenceThicknessRange[1],c.iridescenceMap&&(g.iridescenceMap.value=c.iridescenceMap,n(c.iridescenceMap,g.iridescenceMapTransform)),c.iridescenceThicknessMap&&(g.iridescenceThicknessMap.value=c.iridescenceThicknessMap,n(c.iridescenceThicknessMap,g.iridescenceThicknessMapTransform))),c.transmission>0&&(g.transmission.value=c.transmission,g.transmissionSamplerMap.value=p.texture,g.transmissionSamplerSize.value.set(p.width,p.height),c.transmissionMap&&(g.transmissionMap.value=c.transmissionMap,n(c.transmissionMap,g.transmissionMapTransform)),g.thickness.value=c.thickness,c.thicknessMap&&(g.thicknessMap.value=c.thicknessMap,n(c.thicknessMap,g.thicknessMapTransform)),g.attenuationDistance.value=c.attenuationDistance,g.attenuationColor.value.copy(c.attenuationColor)),c.anisotropy>0&&(g.anisotropyVector.value.set(c.anisotropy*Math.cos(c.anisotropyRotation),c.anisotropy*Math.sin(c.anisotropyRotation)),c.anisotropyMap&&(g.anisotropyMap.value=c.anisotropyMap,n(c.anisotropyMap,g.anisotropyMapTransform))),g.specularIntensity.value=c.specularIntensity,g.specularColor.value.copy(c.specularColor),c.specularColorMap&&(g.specularColorMap.value=c.specularColorMap,n(c.specularColorMap,g.specularColorMapTransform)),c.specularIntensityMap&&(g.specularIntensityMap.value=c.specularIntensityMap,n(c.specularIntensityMap,g.specularIntensityMapTransform))}function _(g,c){c.matcap&&(g.matcap.value=c.matcap)}function E(g,c){const p=e.get(c).light;g.referencePosition.value.setFromMatrixPosition(p.matrixWorld),g.nearDistance.value=p.shadow.camera.near,g.farDistance.value=p.shadow.camera.far}return{refreshFogUniforms:i,refreshMaterialUniforms:r}}function pw(t,e,n,i){let r={},s={},o=[];const a=t.getParameter(t.MAX_UNIFORM_BUFFER_BINDINGS);function l(p,S){const M=S.program;i.uniformBlockBinding(p,M)}function u(p,S){let M=r[p.id];M===void 0&&(_(p),M=d(p),r[p.id]=M,p.addEventListener("dispose",g));const C=S.program;i.updateUBOMapping(p,C);const w=e.render.frame;s[p.id]!==w&&(f(p),s[p.id]=w)}function d(p){const S=h();p.__bindingPointIndex=S;const M=t.createBuffer(),C=p.__size,w=p.usage;return t.bindBuffer(t.UNIFORM_BUFFER,M),t.bufferData(t.UNIFORM_BUFFER,C,w),t.bindBuffer(t.UNIFORM_BUFFER,null),t.bindBufferBase(t.UNIFORM_BUFFER,S,M),M}function h(){for(let p=0;p<a;p++)if(o.indexOf(p)===-1)return o.push(p),p;return et("WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(p){const S=r[p.id],M=p.uniforms,C=p.__cache;t.bindBuffer(t.UNIFORM_BUFFER,S);for(let w=0,A=M.length;w<A;w++){const x=Array.isArray(M[w])?M[w]:[M[w]];for(let R=0,P=x.length;R<P;R++){const b=x[R];if(m(b,w,R,C)===!0){const k=b.__offset,q=Array.isArray(b.value)?b.value:[b.value];let K=0;for(let I=0;I<q.length;I++){const W=q[I],z=E(W);typeof W=="number"||typeof W=="boolean"?(b.__data[0]=W,t.bufferSubData(t.UNIFORM_BUFFER,k+K,b.__data)):W.isMatrix3?(b.__data[0]=W.elements[0],b.__data[1]=W.elements[1],b.__data[2]=W.elements[2],b.__data[3]=0,b.__data[4]=W.elements[3],b.__data[5]=W.elements[4],b.__data[6]=W.elements[5],b.__data[7]=0,b.__data[8]=W.elements[6],b.__data[9]=W.elements[7],b.__data[10]=W.elements[8],b.__data[11]=0):ArrayBuffer.isView(W)?b.__data.set(new W.constructor(W.buffer,W.byteOffset,b.__data.length)):(W.toArray(b.__data,K),K+=z.storage/Float32Array.BYTES_PER_ELEMENT)}t.bufferSubData(t.UNIFORM_BUFFER,k,b.__data)}}}t.bindBuffer(t.UNIFORM_BUFFER,null)}function m(p,S,M,C){const w=p.value,A=S+"_"+M;if(C[A]===void 0)return typeof w=="number"||typeof w=="boolean"?C[A]=w:ArrayBuffer.isView(w)?C[A]=w.slice():C[A]=w.clone(),!0;{const x=C[A];if(typeof w=="number"||typeof w=="boolean"){if(x!==w)return C[A]=w,!0}else{if(ArrayBuffer.isView(w))return!0;if(x.equals(w)===!1)return x.copy(w),!0}}return!1}function _(p){const S=p.uniforms;let M=0;const C=16;for(let A=0,x=S.length;A<x;A++){const R=Array.isArray(S[A])?S[A]:[S[A]];for(let P=0,b=R.length;P<b;P++){const k=R[P],q=Array.isArray(k.value)?k.value:[k.value];for(let K=0,I=q.length;K<I;K++){const W=q[K],z=E(W),B=M%C,j=B%z.boundary,J=B+j;M+=j,J!==0&&C-J<z.storage&&(M+=C-J),k.__data=new Float32Array(z.storage/Float32Array.BYTES_PER_ELEMENT),k.__offset=M,M+=z.storage}}}const w=M%C;return w>0&&(M+=C-w),p.__size=M,p.__cache={},this}function E(p){const S={boundary:0,storage:0};return typeof p=="number"||typeof p=="boolean"?(S.boundary=4,S.storage=4):p.isVector2?(S.boundary=8,S.storage=8):p.isVector3||p.isColor?(S.boundary=16,S.storage=12):p.isVector4?(S.boundary=16,S.storage=16):p.isMatrix3?(S.boundary=48,S.storage=48):p.isMatrix4?(S.boundary=64,S.storage=64):p.isTexture?ze("WebGLRenderer: Texture samplers can not be part of an uniforms group."):ArrayBuffer.isView(p)?(S.boundary=16,S.storage=p.byteLength):ze("WebGLRenderer: Unsupported uniform value type.",p),S}function g(p){const S=p.target;S.removeEventListener("dispose",g);const M=o.indexOf(S.__bindingPointIndex);o.splice(M,1),t.deleteBuffer(r[S.id]),delete r[S.id],delete s[S.id]}function c(){for(const p in r)t.deleteBuffer(r[p]);o=[],r={},s={}}return{bind:l,update:u,dispose:c}}const mw=new Uint16Array([12469,15057,12620,14925,13266,14620,13807,14376,14323,13990,14545,13625,14713,13328,14840,12882,14931,12528,14996,12233,15039,11829,15066,11525,15080,11295,15085,10976,15082,10705,15073,10495,13880,14564,13898,14542,13977,14430,14158,14124,14393,13732,14556,13410,14702,12996,14814,12596,14891,12291,14937,11834,14957,11489,14958,11194,14943,10803,14921,10506,14893,10278,14858,9960,14484,14039,14487,14025,14499,13941,14524,13740,14574,13468,14654,13106,14743,12678,14818,12344,14867,11893,14889,11509,14893,11180,14881,10751,14852,10428,14812,10128,14765,9754,14712,9466,14764,13480,14764,13475,14766,13440,14766,13347,14769,13070,14786,12713,14816,12387,14844,11957,14860,11549,14868,11215,14855,10751,14825,10403,14782,10044,14729,9651,14666,9352,14599,9029,14967,12835,14966,12831,14963,12804,14954,12723,14936,12564,14917,12347,14900,11958,14886,11569,14878,11247,14859,10765,14828,10401,14784,10011,14727,9600,14660,9289,14586,8893,14508,8533,15111,12234,15110,12234,15104,12216,15092,12156,15067,12010,15028,11776,14981,11500,14942,11205,14902,10752,14861,10393,14812,9991,14752,9570,14682,9252,14603,8808,14519,8445,14431,8145,15209,11449,15208,11451,15202,11451,15190,11438,15163,11384,15117,11274,15055,10979,14994,10648,14932,10343,14871,9936,14803,9532,14729,9218,14645,8742,14556,8381,14461,8020,14365,7603,15273,10603,15272,10607,15267,10619,15256,10631,15231,10614,15182,10535,15118,10389,15042,10167,14963,9787,14883,9447,14800,9115,14710,8665,14615,8318,14514,7911,14411,7507,14279,7198,15314,9675,15313,9683,15309,9712,15298,9759,15277,9797,15229,9773,15166,9668,15084,9487,14995,9274,14898,8910,14800,8539,14697,8234,14590,7790,14479,7409,14367,7067,14178,6621,15337,8619,15337,8631,15333,8677,15325,8769,15305,8871,15264,8940,15202,8909,15119,8775,15022,8565,14916,8328,14804,8009,14688,7614,14569,7287,14448,6888,14321,6483,14088,6171,15350,7402,15350,7419,15347,7480,15340,7613,15322,7804,15287,7973,15229,8057,15148,8012,15046,7846,14933,7611,14810,7357,14682,7069,14552,6656,14421,6316,14251,5948,14007,5528,15356,5942,15356,5977,15353,6119,15348,6294,15332,6551,15302,6824,15249,7044,15171,7122,15070,7050,14949,6861,14818,6611,14679,6349,14538,6067,14398,5651,14189,5311,13935,4958,15359,4123,15359,4153,15356,4296,15353,4646,15338,5160,15311,5508,15263,5829,15188,6042,15088,6094,14966,6001,14826,5796,14678,5543,14527,5287,14377,4985,14133,4586,13869,4257,15360,1563,15360,1642,15358,2076,15354,2636,15341,3350,15317,4019,15273,4429,15203,4732,15105,4911,14981,4932,14836,4818,14679,4621,14517,4386,14359,4156,14083,3795,13808,3437,15360,122,15360,137,15358,285,15355,636,15344,1274,15322,2177,15281,2765,15215,3223,15120,3451,14995,3569,14846,3567,14681,3466,14511,3305,14344,3121,14037,2800,13753,2467,15360,0,15360,1,15359,21,15355,89,15346,253,15325,479,15287,796,15225,1148,15133,1492,15008,1749,14856,1882,14685,1886,14506,1783,14324,1608,13996,1398,13702,1183]);let ti=null;function gw(){return ti===null&&(ti=new ly(mw,16,16,zr,di),ti.name="DFG_LUT",ti.minFilter=It,ti.magFilter=It,ti.wrapS=wi,ti.wrapT=wi,ti.generateMipmaps=!1,ti.needsUpdate=!0),ti}class vw{constructor(e={}){const{canvas:n=BS(),context:i=null,depth:r=!0,stencil:s=!1,alpha:o=!1,antialias:a=!1,premultipliedAlpha:l=!0,preserveDrawingBuffer:u=!1,powerPreference:d="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:f=!1,outputBufferType:m=Sn}=e;this.isWebGLRenderer=!0;let _;if(i!==null){if(typeof WebGLRenderingContext<"u"&&i instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");_=i.getContextAttributes().alpha}else _=o;const E=m,g=new Set([$d,qd,Yd]),c=new Set([Sn,fi,Vo,Ho,Xd,jd]),p=new Uint32Array(4),S=new Int32Array(4),M=new G;let C=null,w=null;const A=[],x=[];let R=null;this.domElement=n,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=ui,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const P=this;let b=!1,k=null;this._outputColorSpace=Ln;let q=0,K=0,I=null,W=-1,z=null;const B=new Pt,j=new Pt;let J=null;const fe=new ct(0);let se=0,Le=n.width,He=n.height,Fe=1,Z=null,ae=null;const de=new Pt(0,0,Le,He),Ue=new Pt(0,0,Le,He);let ke=!1;const Ne=new pv;let it=!1,Xe=!1;const Ce=new Ft,Oe=new G,Se=new Pt,ft={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let at=!1;function rt(){return I===null?Fe:1}let L=i;function mt(y,N){return n.getContext(y,N)}try{const y={alpha:!0,depth:r,stencil:s,antialias:a,premultipliedAlpha:l,preserveDrawingBuffer:u,powerPreference:d,failIfMajorPerformanceCaveat:h};if("setAttribute"in n&&n.setAttribute("data-engine",`three.js r${Gd}`),n.addEventListener("webglcontextlost",ie,!1),n.addEventListener("webglcontextrestored",Ae,!1),n.addEventListener("webglcontextcreationerror",Ve,!1),L===null){const N="webgl2";if(L=mt(N,y),L===null)throw mt(N)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(y){throw et("WebGLRenderer: "+y.message),y}let Be,$e,me,dt,T,v,O,Q,F,ne,re,Y,ee,ge,ye,le,ue,Re,Me,je,D,ce,$;function pe(){Be=new g1(L),Be.init(),D=new aw(L,Be),$e=new l1(L,Be,e,D),me=new sw(L,Be),$e.reversedDepthBuffer&&f&&me.buffers.depth.setReversed(!0),dt=new x1(L),T=new XT,v=new ow(L,Be,me,T,$e,D,dt),O=new m1(P),Q=new Ey(L),ce=new o1(L,Q),F=new v1(L,Q,dt,ce),ne=new y1(L,F,Q,ce,dt),Re=new S1(L,$e,v),ye=new u1(T),re=new WT(P,O,Be,$e,ce,ye),Y=new hw(P,T),ee=new YT,ge=new JT(Be),ue=new s1(P,O,me,ne,_,l),le=new rw(P,ne,$e),$=new pw(L,dt,$e,me),Me=new a1(L,Be,dt),je=new _1(L,Be,dt),dt.programs=re.programs,P.capabilities=$e,P.extensions=Be,P.properties=T,P.renderLists=ee,P.shadowMap=le,P.state=me,P.info=dt}pe(),E!==Sn&&(R=new E1(E,n.width,n.height,r,s));const he=new fw(P,L);this.xr=he,this.getContext=function(){return L},this.getContextAttributes=function(){return L.getContextAttributes()},this.forceContextLoss=function(){const y=Be.get("WEBGL_lose_context");y&&y.loseContext()},this.forceContextRestore=function(){const y=Be.get("WEBGL_lose_context");y&&y.restoreContext()},this.getPixelRatio=function(){return Fe},this.setPixelRatio=function(y){y!==void 0&&(Fe=y,this.setSize(Le,He,!1))},this.getSize=function(y){return y.set(Le,He)},this.setSize=function(y,N,X=!0){if(he.isPresenting){ze("WebGLRenderer: Can't change size while VR device is presenting.");return}Le=y,He=N,n.width=Math.floor(y*Fe),n.height=Math.floor(N*Fe),X===!0&&(n.style.width=y+"px",n.style.height=N+"px"),R!==null&&R.setSize(n.width,n.height),this.setViewport(0,0,y,N)},this.getDrawingBufferSize=function(y){return y.set(Le*Fe,He*Fe).floor()},this.setDrawingBufferSize=function(y,N,X){Le=y,He=N,Fe=X,n.width=Math.floor(y*X),n.height=Math.floor(N*X),this.setViewport(0,0,y,N)},this.setEffects=function(y){if(E===Sn){et("THREE.WebGLRenderer: setEffects() requires outputBufferType set to HalfFloatType or FloatType.");return}if(y){for(let N=0;N<y.length;N++)if(y[N].isOutputPass===!0){ze("THREE.WebGLRenderer: OutputPass is not needed in setEffects(). Tone mapping and color space conversion are applied automatically.");break}}R.setEffects(y||[])},this.getCurrentViewport=function(y){return y.copy(B)},this.getViewport=function(y){return y.copy(de)},this.setViewport=function(y,N,X,V){y.isVector4?de.set(y.x,y.y,y.z,y.w):de.set(y,N,X,V),me.viewport(B.copy(de).multiplyScalar(Fe).round())},this.getScissor=function(y){return y.copy(Ue)},this.setScissor=function(y,N,X,V){y.isVector4?Ue.set(y.x,y.y,y.z,y.w):Ue.set(y,N,X,V),me.scissor(j.copy(Ue).multiplyScalar(Fe).round())},this.getScissorTest=function(){return ke},this.setScissorTest=function(y){me.setScissorTest(ke=y)},this.setOpaqueSort=function(y){Z=y},this.setTransparentSort=function(y){ae=y},this.getClearColor=function(y){return y.copy(ue.getClearColor())},this.setClearColor=function(){ue.setClearColor(...arguments)},this.getClearAlpha=function(){return ue.getClearAlpha()},this.setClearAlpha=function(){ue.setClearAlpha(...arguments)},this.clear=function(y=!0,N=!0,X=!0){let V=0;if(y){let H=!1;if(I!==null){const xe=I.texture.format;H=g.has(xe)}if(H){const xe=I.texture.type,Te=c.has(xe),_e=ue.getClearColor(),be=ue.getClearAlpha(),Pe=_e.r,We=_e.g,qe=_e.b;Te?(p[0]=Pe,p[1]=We,p[2]=qe,p[3]=be,L.clearBufferuiv(L.COLOR,0,p)):(S[0]=Pe,S[1]=We,S[2]=qe,S[3]=be,L.clearBufferiv(L.COLOR,0,S))}else V|=L.COLOR_BUFFER_BIT}N&&(V|=L.DEPTH_BUFFER_BIT,this.state.buffers.depth.setMask(!0)),X&&(V|=L.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),V!==0&&L.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.setNodesHandler=function(y){y.setRenderer(this),k=y},this.dispose=function(){n.removeEventListener("webglcontextlost",ie,!1),n.removeEventListener("webglcontextrestored",Ae,!1),n.removeEventListener("webglcontextcreationerror",Ve,!1),ue.dispose(),ee.dispose(),ge.dispose(),T.dispose(),O.dispose(),ne.dispose(),ce.dispose(),$.dispose(),re.dispose(),he.dispose(),he.removeEventListener("sessionstart",lh),he.removeEventListener("sessionend",uh),gr.stop()};function ie(y){y.preventDefault(),Up("WebGLRenderer: Context Lost."),b=!0}function Ae(){Up("WebGLRenderer: Context Restored."),b=!1;const y=dt.autoReset,N=le.enabled,X=le.autoUpdate,V=le.needsUpdate,H=le.type;pe(),dt.autoReset=y,le.enabled=N,le.autoUpdate=X,le.needsUpdate=V,le.type=H}function Ve(y){et("WebGLRenderer: A WebGL context could not be created. Reason: ",y.statusMessage)}function At(y){const N=y.target;N.removeEventListener("dispose",At),lt(N)}function lt(y){pi(y),T.remove(y)}function pi(y){const N=T.get(y).programs;N!==void 0&&(N.forEach(function(X){re.releaseProgram(X)}),y.isShaderMaterial&&re.releaseShaderCache(y))}this.renderBufferDirect=function(y,N,X,V,H,xe){N===null&&(N=ft);const Te=H.isMesh&&H.matrixWorld.determinant()<0,_e=Pv(y,N,X,V,H);me.setMaterial(V,Te);let be=X.index,Pe=1;if(V.wireframe===!0){if(be=F.getWireframeAttribute(X),be===void 0)return;Pe=2}const We=X.drawRange,qe=X.attributes.position;let De=We.start*Pe,ut=(We.start+We.count)*Pe;xe!==null&&(De=Math.max(De,xe.start*Pe),ut=Math.min(ut,(xe.start+xe.count)*Pe)),be!==null?(De=Math.max(De,0),ut=Math.min(ut,be.count)):qe!=null&&(De=Math.max(De,0),ut=Math.min(ut,qe.count));const Ct=ut-De;if(Ct<0||Ct===1/0)return;ce.setup(H,V,_e,X,be);let Tt,ht=Me;if(be!==null&&(Tt=Q.get(be),ht=je,ht.setIndex(Tt)),H.isMesh)V.wireframe===!0?(me.setLineWidth(V.wireframeLinewidth*rt()),ht.setMode(L.LINES)):ht.setMode(L.TRIANGLES);else if(H.isLine){let jt=V.linewidth;jt===void 0&&(jt=1),me.setLineWidth(jt*rt()),H.isLineSegments?ht.setMode(L.LINES):H.isLineLoop?ht.setMode(L.LINE_LOOP):ht.setMode(L.LINE_STRIP)}else H.isPoints?ht.setMode(L.POINTS):H.isSprite&&ht.setMode(L.TRIANGLES);if(H.isBatchedMesh)if(Be.get("WEBGL_multi_draw"))ht.renderMultiDraw(H._multiDrawStarts,H._multiDrawCounts,H._multiDrawCount);else{const jt=H._multiDrawStarts,Ee=H._multiDrawCounts,pn=H._multiDrawCount,Je=be?Q.get(be).bytesPerElement:1,bn=T.get(V).currentProgram.getUniforms();for(let Qn=0;Qn<pn;Qn++)bn.setValue(L,"_gl_DrawID",Qn),ht.render(jt[Qn]/Je,Ee[Qn])}else if(H.isInstancedMesh)ht.renderInstances(De,Ct,H.count);else if(X.isInstancedBufferGeometry){const jt=X._maxInstanceCount!==void 0?X._maxInstanceCount:1/0,Ee=Math.min(X.instanceCount,jt);ht.renderInstances(De,Ct,Ee)}else ht.render(De,Ct)};function Zn(y,N,X){y.transparent===!0&&y.side===Mi&&y.forceSinglePass===!1?(y.side=hn,y.needsUpdate=!0,Jo(y,N,X),y.side=dr,y.needsUpdate=!0,Jo(y,N,X),y.side=Mi):Jo(y,N,X)}this.compile=function(y,N,X=null){X===null&&(X=y),w=ge.get(X),w.init(N),x.push(w),X.traverseVisible(function(H){H.isLight&&H.layers.test(N.layers)&&(w.pushLight(H),H.castShadow&&w.pushShadow(H))}),y!==X&&y.traverseVisible(function(H){H.isLight&&H.layers.test(N.layers)&&(w.pushLight(H),H.castShadow&&w.pushShadow(H))}),w.setupLights();const V=new Set;return y.traverse(function(H){if(!(H.isMesh||H.isPoints||H.isLine||H.isSprite))return;const xe=H.material;if(xe)if(Array.isArray(xe))for(let Te=0;Te<xe.length;Te++){const _e=xe[Te];Zn(_e,X,H),V.add(_e)}else Zn(xe,X,H),V.add(xe)}),w=x.pop(),V},this.compileAsync=function(y,N,X=null){const V=this.compile(y,N,X);return new Promise(H=>{function xe(){if(V.forEach(function(Te){T.get(Te).currentProgram.isReady()&&V.delete(Te)}),V.size===0){H(y);return}setTimeout(xe,10)}Be.get("KHR_parallel_shader_compile")!==null?xe():setTimeout(xe,10)})};let nu=null;function Rv(y){nu&&nu(y)}function lh(){gr.stop()}function uh(){gr.start()}const gr=new xv;gr.setAnimationLoop(Rv),typeof self<"u"&&gr.setContext(self),this.setAnimationLoop=function(y){nu=y,he.setAnimationLoop(y),y===null?gr.stop():gr.start()},he.addEventListener("sessionstart",lh),he.addEventListener("sessionend",uh),this.render=function(y,N){if(N!==void 0&&N.isCamera!==!0){et("WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(b===!0)return;k!==null&&k.renderStart(y,N);const X=he.enabled===!0&&he.isPresenting===!0,V=R!==null&&(I===null||X)&&R.begin(P,I);if(y.matrixWorldAutoUpdate===!0&&y.updateMatrixWorld(),N.parent===null&&N.matrixWorldAutoUpdate===!0&&N.updateMatrixWorld(),he.enabled===!0&&he.isPresenting===!0&&(R===null||R.isCompositing()===!1)&&(he.cameraAutoUpdate===!0&&he.updateCamera(N),N=he.getCamera()),y.isScene===!0&&y.onBeforeRender(P,y,N,I),w=ge.get(y,x.length),w.init(N),w.state.textureUnits=v.getTextureUnits(),x.push(w),Ce.multiplyMatrices(N.projectionMatrix,N.matrixWorldInverse),Ne.setFromProjectionMatrix(Ce,oi,N.reversedDepth),Xe=this.localClippingEnabled,it=ye.init(this.clippingPlanes,Xe),C=ee.get(y,A.length),C.init(),A.push(C),he.enabled===!0&&he.isPresenting===!0){const Te=P.xr.getDepthSensingMesh();Te!==null&&iu(Te,N,-1/0,P.sortObjects)}iu(y,N,0,P.sortObjects),C.finish(),P.sortObjects===!0&&C.sort(Z,ae),at=he.enabled===!1||he.isPresenting===!1||he.hasDepthSensing()===!1,at&&ue.addToRenderList(C,y),this.info.render.frame++,it===!0&&ye.beginShadows();const H=w.state.shadowsArray;if(le.render(H,y,N),it===!0&&ye.endShadows(),this.info.autoReset===!0&&this.info.reset(),(V&&R.hasRenderPass())===!1){const Te=C.opaque,_e=C.transmissive;if(w.setupLights(),N.isArrayCamera){const be=N.cameras;if(_e.length>0)for(let Pe=0,We=be.length;Pe<We;Pe++){const qe=be[Pe];fh(Te,_e,y,qe)}at&&ue.render(y);for(let Pe=0,We=be.length;Pe<We;Pe++){const qe=be[Pe];ch(C,y,qe,qe.viewport)}}else _e.length>0&&fh(Te,_e,y,N),at&&ue.render(y),ch(C,y,N)}I!==null&&K===0&&(v.updateMultisampleRenderTarget(I),v.updateRenderTargetMipmap(I)),V&&R.end(P),y.isScene===!0&&y.onAfterRender(P,y,N),ce.resetDefaultState(),W=-1,z=null,x.pop(),x.length>0?(w=x[x.length-1],v.setTextureUnits(w.state.textureUnits),it===!0&&ye.setGlobalState(P.clippingPlanes,w.state.camera)):w=null,A.pop(),A.length>0?C=A[A.length-1]:C=null,k!==null&&k.renderEnd()};function iu(y,N,X,V){if(y.visible===!1)return;if(y.layers.test(N.layers)){if(y.isGroup)X=y.renderOrder;else if(y.isLOD)y.autoUpdate===!0&&y.update(N);else if(y.isLightProbeGrid)w.pushLightProbeGrid(y);else if(y.isLight)w.pushLight(y),y.castShadow&&w.pushShadow(y);else if(y.isSprite){if(!y.frustumCulled||Ne.intersectsSprite(y)){V&&Se.setFromMatrixPosition(y.matrixWorld).applyMatrix4(Ce);const Te=ne.update(y),_e=y.material;_e.visible&&C.push(y,Te,_e,X,Se.z,null)}}else if((y.isMesh||y.isLine||y.isPoints)&&(!y.frustumCulled||Ne.intersectsObject(y))){const Te=ne.update(y),_e=y.material;if(V&&(y.boundingSphere!==void 0?(y.boundingSphere===null&&y.computeBoundingSphere(),Se.copy(y.boundingSphere.center)):(Te.boundingSphere===null&&Te.computeBoundingSphere(),Se.copy(Te.boundingSphere.center)),Se.applyMatrix4(y.matrixWorld).applyMatrix4(Ce)),Array.isArray(_e)){const be=Te.groups;for(let Pe=0,We=be.length;Pe<We;Pe++){const qe=be[Pe],De=_e[qe.materialIndex];De&&De.visible&&C.push(y,Te,De,X,Se.z,qe)}}else _e.visible&&C.push(y,Te,_e,X,Se.z,null)}}const xe=y.children;for(let Te=0,_e=xe.length;Te<_e;Te++)iu(xe[Te],N,X,V)}function ch(y,N,X,V){const{opaque:H,transmissive:xe,transparent:Te}=y;w.setupLightsView(X),it===!0&&ye.setGlobalState(P.clippingPlanes,X),V&&me.viewport(B.copy(V)),H.length>0&&Qo(H,N,X),xe.length>0&&Qo(xe,N,X),Te.length>0&&Qo(Te,N,X),me.buffers.depth.setTest(!0),me.buffers.depth.setMask(!0),me.buffers.color.setMask(!0),me.setPolygonOffset(!1)}function fh(y,N,X,V){if((X.isScene===!0?X.overrideMaterial:null)!==null)return;if(w.state.transmissionRenderTarget[V.id]===void 0){const De=Be.has("EXT_color_buffer_half_float")||Be.has("EXT_color_buffer_float");w.state.transmissionRenderTarget[V.id]=new tn(1,1,{generateMipmaps:!0,type:De?di:Sn,minFilter:br,samples:Math.max(4,$e.samples),stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:Ze.workingColorSpace})}const xe=w.state.transmissionRenderTarget[V.id],Te=V.viewport||B;xe.setSize(Te.z*P.transmissionResolutionScale,Te.w*P.transmissionResolutionScale);const _e=P.getRenderTarget(),be=P.getActiveCubeFace(),Pe=P.getActiveMipmapLevel();P.setRenderTarget(xe),P.getClearColor(fe),se=P.getClearAlpha(),se<1&&P.setClearColor(16777215,.5),P.clear(),at&&ue.render(X);const We=P.toneMapping;P.toneMapping=ui;const qe=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),w.setupLightsView(V),it===!0&&ye.setGlobalState(P.clippingPlanes,V),Qo(y,X,V),v.updateMultisampleRenderTarget(xe),v.updateRenderTargetMipmap(xe),Be.has("WEBGL_multisampled_render_to_texture")===!1){let De=!1;for(let ut=0,Ct=N.length;ut<Ct;ut++){const Tt=N[ut],{object:ht,geometry:jt,material:Ee,group:pn}=Tt;if(Ee.side===Mi&&ht.layers.test(V.layers)){const Je=Ee.side;Ee.side=hn,Ee.needsUpdate=!0,dh(ht,X,V,jt,Ee,pn),Ee.side=Je,Ee.needsUpdate=!0,De=!0}}De===!0&&(v.updateMultisampleRenderTarget(xe),v.updateRenderTargetMipmap(xe))}P.setRenderTarget(_e,be,Pe),P.setClearColor(fe,se),qe!==void 0&&(V.viewport=qe),P.toneMapping=We}function Qo(y,N,X){const V=N.isScene===!0?N.overrideMaterial:null;for(let H=0,xe=y.length;H<xe;H++){const Te=y[H],{object:_e,geometry:be,group:Pe}=Te;let We=Te.material;We.allowOverride===!0&&V!==null&&(We=V),_e.layers.test(X.layers)&&dh(_e,N,X,be,We,Pe)}}function dh(y,N,X,V,H,xe){y.onBeforeRender(P,N,X,V,H,xe),y.modelViewMatrix.multiplyMatrices(X.matrixWorldInverse,y.matrixWorld),y.normalMatrix.getNormalMatrix(y.modelViewMatrix),H.onBeforeRender(P,N,X,V,y,xe),H.transparent===!0&&H.side===Mi&&H.forceSinglePass===!1?(H.side=hn,H.needsUpdate=!0,P.renderBufferDirect(X,N,V,H,y,xe),H.side=dr,H.needsUpdate=!0,P.renderBufferDirect(X,N,V,H,y,xe),H.side=Mi):P.renderBufferDirect(X,N,V,H,y,xe),y.onAfterRender(P,N,X,V,H,xe)}function Jo(y,N,X){N.isScene!==!0&&(N=ft);const V=T.get(y),H=w.state.lights,xe=w.state.shadowsArray,Te=H.state.version,_e=re.getParameters(y,H.state,xe,N,X,w.state.lightProbeGridArray),be=re.getProgramCacheKey(_e);let Pe=V.programs;V.environment=y.isMeshStandardMaterial||y.isMeshLambertMaterial||y.isMeshPhongMaterial?N.environment:null,V.fog=N.fog;const We=y.isMeshStandardMaterial||y.isMeshLambertMaterial&&!y.envMap||y.isMeshPhongMaterial&&!y.envMap;V.envMap=O.get(y.envMap||V.environment,We),V.envMapRotation=V.environment!==null&&y.envMap===null?N.environmentRotation:y.envMapRotation,Pe===void 0&&(y.addEventListener("dispose",At),Pe=new Map,V.programs=Pe);let qe=Pe.get(be);if(qe!==void 0){if(V.currentProgram===qe&&V.lightsStateVersion===Te)return ph(y,_e),qe}else _e.uniforms=re.getUniforms(y),k!==null&&y.isNodeMaterial&&k.build(y,X,_e),y.onBeforeCompile(_e,P),qe=re.acquireProgram(_e,be),Pe.set(be,qe),V.uniforms=_e.uniforms;const De=V.uniforms;return(!y.isShaderMaterial&&!y.isRawShaderMaterial||y.clipping===!0)&&(De.clippingPlanes=ye.uniform),ph(y,_e),V.needsLights=Lv(y),V.lightsStateVersion=Te,V.needsLights&&(De.ambientLightColor.value=H.state.ambient,De.lightProbe.value=H.state.probe,De.directionalLights.value=H.state.directional,De.directionalLightShadows.value=H.state.directionalShadow,De.spotLights.value=H.state.spot,De.spotLightShadows.value=H.state.spotShadow,De.rectAreaLights.value=H.state.rectArea,De.ltc_1.value=H.state.rectAreaLTC1,De.ltc_2.value=H.state.rectAreaLTC2,De.pointLights.value=H.state.point,De.pointLightShadows.value=H.state.pointShadow,De.hemisphereLights.value=H.state.hemi,De.directionalShadowMatrix.value=H.state.directionalShadowMatrix,De.spotLightMatrix.value=H.state.spotLightMatrix,De.spotLightMap.value=H.state.spotLightMap,De.pointShadowMatrix.value=H.state.pointShadowMatrix),V.lightProbeGrid=w.state.lightProbeGridArray.length>0,V.currentProgram=qe,V.uniformsList=null,qe}function hh(y){if(y.uniformsList===null){const N=y.currentProgram.getUniforms();y.uniformsList=il.seqWithValue(N.seq,y.uniforms)}return y.uniformsList}function ph(y,N){const X=T.get(y);X.outputColorSpace=N.outputColorSpace,X.batching=N.batching,X.batchingColor=N.batchingColor,X.instancing=N.instancing,X.instancingColor=N.instancingColor,X.instancingMorph=N.instancingMorph,X.skinning=N.skinning,X.morphTargets=N.morphTargets,X.morphNormals=N.morphNormals,X.morphColors=N.morphColors,X.morphTargetsCount=N.morphTargetsCount,X.numClippingPlanes=N.numClippingPlanes,X.numIntersection=N.numClipIntersection,X.vertexAlphas=N.vertexAlphas,X.vertexTangents=N.vertexTangents,X.toneMapping=N.toneMapping}function bv(y,N){if(y.length===0)return null;if(y.length===1)return y[0].texture!==null?y[0]:null;M.setFromMatrixPosition(N.matrixWorld);for(let X=0,V=y.length;X<V;X++){const H=y[X];if(H.texture!==null&&H.boundingBox.containsPoint(M))return H}return null}function Pv(y,N,X,V,H){N.isScene!==!0&&(N=ft),v.resetTextureUnits();const xe=N.fog,Te=V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial?N.environment:null,_e=I===null?P.outputColorSpace:I.isXRRenderTarget===!0?I.texture.colorSpace:Ze.workingColorSpace,be=V.isMeshStandardMaterial||V.isMeshLambertMaterial&&!V.envMap||V.isMeshPhongMaterial&&!V.envMap,Pe=O.get(V.envMap||Te,be),We=V.vertexColors===!0&&!!X.attributes.color&&X.attributes.color.itemSize===4,qe=!!X.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),De=!!X.morphAttributes.position,ut=!!X.morphAttributes.normal,Ct=!!X.morphAttributes.color;let Tt=ui;V.toneMapped&&(I===null||I.isXRRenderTarget===!0)&&(Tt=P.toneMapping);const ht=X.morphAttributes.position||X.morphAttributes.normal||X.morphAttributes.color,jt=ht!==void 0?ht.length:0,Ee=T.get(V),pn=w.state.lights;if(it===!0&&(Xe===!0||y!==z)){const gt=y===z&&V.id===W;ye.setState(V,y,gt)}let Je=!1;V.version===Ee.__version?(Ee.needsLights&&Ee.lightsStateVersion!==pn.state.version||Ee.outputColorSpace!==_e||H.isBatchedMesh&&Ee.batching===!1||!H.isBatchedMesh&&Ee.batching===!0||H.isBatchedMesh&&Ee.batchingColor===!0&&H.colorTexture===null||H.isBatchedMesh&&Ee.batchingColor===!1&&H.colorTexture!==null||H.isInstancedMesh&&Ee.instancing===!1||!H.isInstancedMesh&&Ee.instancing===!0||H.isSkinnedMesh&&Ee.skinning===!1||!H.isSkinnedMesh&&Ee.skinning===!0||H.isInstancedMesh&&Ee.instancingColor===!0&&H.instanceColor===null||H.isInstancedMesh&&Ee.instancingColor===!1&&H.instanceColor!==null||H.isInstancedMesh&&Ee.instancingMorph===!0&&H.morphTexture===null||H.isInstancedMesh&&Ee.instancingMorph===!1&&H.morphTexture!==null||Ee.envMap!==Pe||V.fog===!0&&Ee.fog!==xe||Ee.numClippingPlanes!==void 0&&(Ee.numClippingPlanes!==ye.numPlanes||Ee.numIntersection!==ye.numIntersection)||Ee.vertexAlphas!==We||Ee.vertexTangents!==qe||Ee.morphTargets!==De||Ee.morphNormals!==ut||Ee.morphColors!==Ct||Ee.toneMapping!==Tt||Ee.morphTargetsCount!==jt||!!Ee.lightProbeGrid!=w.state.lightProbeGridArray.length>0)&&(Je=!0):(Je=!0,Ee.__version=V.version);let bn=Ee.currentProgram;Je===!0&&(bn=Jo(V,N,H),k&&V.isNodeMaterial&&k.onUpdateProgram(V,bn,Ee));let Qn=!1,Oi=!1,Xr=!1;const pt=bn.getUniforms(),Rt=Ee.uniforms;if(me.useProgram(bn.program)&&(Qn=!0,Oi=!0,Xr=!0),V.id!==W&&(W=V.id,Oi=!0),Ee.needsLights){const gt=bv(w.state.lightProbeGridArray,H);Ee.lightProbeGrid!==gt&&(Ee.lightProbeGrid=gt,Oi=!0)}if(Qn||z!==y){me.buffers.depth.getReversed()&&y.reversedDepth!==!0&&(y._reversedDepth=!0,y.updateProjectionMatrix()),pt.setValue(L,"projectionMatrix",y.projectionMatrix),pt.setValue(L,"viewMatrix",y.matrixWorldInverse);const ki=pt.map.cameraPosition;ki!==void 0&&ki.setValue(L,Oe.setFromMatrixPosition(y.matrixWorld)),$e.logarithmicDepthBuffer&&pt.setValue(L,"logDepthBufFC",2/(Math.log(y.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&pt.setValue(L,"isOrthographic",y.isOrthographicCamera===!0),z!==y&&(z=y,Oi=!0,Xr=!0)}if(Ee.needsLights&&(pn.state.directionalShadowMap.length>0&&pt.setValue(L,"directionalShadowMap",pn.state.directionalShadowMap,v),pn.state.spotShadowMap.length>0&&pt.setValue(L,"spotShadowMap",pn.state.spotShadowMap,v),pn.state.pointShadowMap.length>0&&pt.setValue(L,"pointShadowMap",pn.state.pointShadowMap,v)),H.isSkinnedMesh){pt.setOptional(L,H,"bindMatrix"),pt.setOptional(L,H,"bindMatrixInverse");const gt=H.skeleton;gt&&(gt.boneTexture===null&&gt.computeBoneTexture(),pt.setValue(L,"boneTexture",gt.boneTexture,v))}H.isBatchedMesh&&(pt.setOptional(L,H,"batchingTexture"),pt.setValue(L,"batchingTexture",H._matricesTexture,v),pt.setOptional(L,H,"batchingIdTexture"),pt.setValue(L,"batchingIdTexture",H._indirectTexture,v),pt.setOptional(L,H,"batchingColorTexture"),H._colorsTexture!==null&&pt.setValue(L,"batchingColorTexture",H._colorsTexture,v));const Bi=X.morphAttributes;if((Bi.position!==void 0||Bi.normal!==void 0||Bi.color!==void 0)&&Re.update(H,X,bn),(Oi||Ee.receiveShadow!==H.receiveShadow)&&(Ee.receiveShadow=H.receiveShadow,pt.setValue(L,"receiveShadow",H.receiveShadow)),(V.isMeshStandardMaterial||V.isMeshLambertMaterial||V.isMeshPhongMaterial)&&V.envMap===null&&N.environment!==null&&(Rt.envMapIntensity.value=N.environmentIntensity),Rt.dfgLUT!==void 0&&(Rt.dfgLUT.value=gw()),Oi){if(pt.setValue(L,"toneMappingExposure",P.toneMappingExposure),Ee.needsLights&&Dv(Rt,Xr),xe&&V.fog===!0&&Y.refreshFogUniforms(Rt,xe),Y.refreshMaterialUniforms(Rt,V,Fe,He,w.state.transmissionRenderTarget[y.id]),Ee.needsLights&&Ee.lightProbeGrid){const gt=Ee.lightProbeGrid;Rt.probesSH.value=gt.texture,Rt.probesMin.value.copy(gt.boundingBox.min),Rt.probesMax.value.copy(gt.boundingBox.max),Rt.probesResolution.value.copy(gt.resolution)}il.upload(L,hh(Ee),Rt,v)}if(V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(il.upload(L,hh(Ee),Rt,v),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&pt.setValue(L,"center",H.center),pt.setValue(L,"modelViewMatrix",H.modelViewMatrix),pt.setValue(L,"normalMatrix",H.normalMatrix),pt.setValue(L,"modelMatrix",H.matrixWorld),V.uniformsGroups!==void 0){const gt=V.uniformsGroups;for(let ki=0,jr=gt.length;ki<jr;ki++){const mh=gt[ki];$.update(mh,bn),$.bind(mh,bn)}}return bn}function Dv(y,N){y.ambientLightColor.needsUpdate=N,y.lightProbe.needsUpdate=N,y.directionalLights.needsUpdate=N,y.directionalLightShadows.needsUpdate=N,y.pointLights.needsUpdate=N,y.pointLightShadows.needsUpdate=N,y.spotLights.needsUpdate=N,y.spotLightShadows.needsUpdate=N,y.rectAreaLights.needsUpdate=N,y.hemisphereLights.needsUpdate=N}function Lv(y){return y.isMeshLambertMaterial||y.isMeshToonMaterial||y.isMeshPhongMaterial||y.isMeshStandardMaterial||y.isShadowMaterial||y.isShaderMaterial&&y.lights===!0}this.getActiveCubeFace=function(){return q},this.getActiveMipmapLevel=function(){return K},this.getRenderTarget=function(){return I},this.setRenderTargetTextures=function(y,N,X){const V=T.get(y);V.__autoAllocateDepthBuffer=y.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),T.get(y.texture).__webglTexture=N,T.get(y.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:X,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(y,N){const X=T.get(y);X.__webglFramebuffer=N,X.__useDefaultFramebuffer=N===void 0};const Iv=L.createFramebuffer();this.setRenderTarget=function(y,N=0,X=0){I=y,q=N,K=X;let V=null,H=!1,xe=!1;if(y){const _e=T.get(y);if(_e.__useDefaultFramebuffer!==void 0){me.bindFramebuffer(L.FRAMEBUFFER,_e.__webglFramebuffer),B.copy(y.viewport),j.copy(y.scissor),J=y.scissorTest,me.viewport(B),me.scissor(j),me.setScissorTest(J),W=-1;return}else if(_e.__webglFramebuffer===void 0)v.setupRenderTarget(y);else if(_e.__hasExternalTextures)v.rebindTextures(y,T.get(y.texture).__webglTexture,T.get(y.depthTexture).__webglTexture);else if(y.depthBuffer){const We=y.depthTexture;if(_e.__boundDepthTexture!==We){if(We!==null&&T.has(We)&&(y.width!==We.image.width||y.height!==We.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");v.setupDepthRenderbuffer(y)}}const be=y.texture;(be.isData3DTexture||be.isDataArrayTexture||be.isCompressedArrayTexture)&&(xe=!0);const Pe=T.get(y).__webglFramebuffer;y.isWebGLCubeRenderTarget?(Array.isArray(Pe[N])?V=Pe[N][X]:V=Pe[N],H=!0):y.samples>0&&v.useMultisampledRTT(y)===!1?V=T.get(y).__webglMultisampledFramebuffer:Array.isArray(Pe)?V=Pe[X]:V=Pe,B.copy(y.viewport),j.copy(y.scissor),J=y.scissorTest}else B.copy(de).multiplyScalar(Fe).floor(),j.copy(Ue).multiplyScalar(Fe).floor(),J=ke;if(X!==0&&(V=Iv),me.bindFramebuffer(L.FRAMEBUFFER,V)&&me.drawBuffers(y,V),me.viewport(B),me.scissor(j),me.setScissorTest(J),H){const _e=T.get(y.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_CUBE_MAP_POSITIVE_X+N,_e.__webglTexture,X)}else if(xe){const _e=N;for(let be=0;be<y.textures.length;be++){const Pe=T.get(y.textures[be]);L.framebufferTextureLayer(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0+be,Pe.__webglTexture,X,_e)}}else if(y!==null&&X!==0){const _e=T.get(y.texture);L.framebufferTexture2D(L.FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,_e.__webglTexture,X)}W=-1},this.readRenderTargetPixels=function(y,N,X,V,H,xe,Te,_e=0){if(!(y&&y.isWebGLRenderTarget)){et("WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let be=T.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&Te!==void 0&&(be=be[Te]),be){me.bindFramebuffer(L.FRAMEBUFFER,be);try{const Pe=y.textures[_e],We=Pe.format,qe=Pe.type;if(y.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+_e),!$e.textureFormatReadable(We)){et("WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!$e.textureTypeReadable(qe)){et("WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}N>=0&&N<=y.width-V&&X>=0&&X<=y.height-H&&L.readPixels(N,X,V,H,D.convert(We),D.convert(qe),xe)}finally{const Pe=I!==null?T.get(I).__webglFramebuffer:null;me.bindFramebuffer(L.FRAMEBUFFER,Pe)}}},this.readRenderTargetPixelsAsync=async function(y,N,X,V,H,xe,Te,_e=0){if(!(y&&y.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let be=T.get(y).__webglFramebuffer;if(y.isWebGLCubeRenderTarget&&Te!==void 0&&(be=be[Te]),be)if(N>=0&&N<=y.width-V&&X>=0&&X<=y.height-H){me.bindFramebuffer(L.FRAMEBUFFER,be);const Pe=y.textures[_e],We=Pe.format,qe=Pe.type;if(y.textures.length>1&&L.readBuffer(L.COLOR_ATTACHMENT0+_e),!$e.textureFormatReadable(We))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!$e.textureTypeReadable(qe))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const De=L.createBuffer();L.bindBuffer(L.PIXEL_PACK_BUFFER,De),L.bufferData(L.PIXEL_PACK_BUFFER,xe.byteLength,L.STREAM_READ),L.readPixels(N,X,V,H,D.convert(We),D.convert(qe),0);const ut=I!==null?T.get(I).__webglFramebuffer:null;me.bindFramebuffer(L.FRAMEBUFFER,ut);const Ct=L.fenceSync(L.SYNC_GPU_COMMANDS_COMPLETE,0);return L.flush(),await kS(L,Ct,4),L.bindBuffer(L.PIXEL_PACK_BUFFER,De),L.getBufferSubData(L.PIXEL_PACK_BUFFER,0,xe),L.deleteBuffer(De),L.deleteSync(Ct),xe}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(y,N=null,X=0){const V=Math.pow(2,-X),H=Math.floor(y.image.width*V),xe=Math.floor(y.image.height*V),Te=N!==null?N.x:0,_e=N!==null?N.y:0;v.setTexture2D(y,0),L.copyTexSubImage2D(L.TEXTURE_2D,X,0,0,Te,_e,H,xe),me.unbindTexture()};const Uv=L.createFramebuffer(),Nv=L.createFramebuffer();this.copyTextureToTexture=function(y,N,X=null,V=null,H=0,xe=0){let Te,_e,be,Pe,We,qe,De,ut,Ct;const Tt=y.isCompressedTexture?y.mipmaps[xe]:y.image;if(X!==null)Te=X.max.x-X.min.x,_e=X.max.y-X.min.y,be=X.isBox3?X.max.z-X.min.z:1,Pe=X.min.x,We=X.min.y,qe=X.isBox3?X.min.z:0;else{const Rt=Math.pow(2,-H);Te=Math.floor(Tt.width*Rt),_e=Math.floor(Tt.height*Rt),y.isDataArrayTexture?be=Tt.depth:y.isData3DTexture?be=Math.floor(Tt.depth*Rt):be=1,Pe=0,We=0,qe=0}V!==null?(De=V.x,ut=V.y,Ct=V.z):(De=0,ut=0,Ct=0);const ht=D.convert(N.format),jt=D.convert(N.type);let Ee;N.isData3DTexture?(v.setTexture3D(N,0),Ee=L.TEXTURE_3D):N.isDataArrayTexture||N.isCompressedArrayTexture?(v.setTexture2DArray(N,0),Ee=L.TEXTURE_2D_ARRAY):(v.setTexture2D(N,0),Ee=L.TEXTURE_2D),me.activeTexture(L.TEXTURE0),me.pixelStorei(L.UNPACK_FLIP_Y_WEBGL,N.flipY),me.pixelStorei(L.UNPACK_PREMULTIPLY_ALPHA_WEBGL,N.premultiplyAlpha),me.pixelStorei(L.UNPACK_ALIGNMENT,N.unpackAlignment);const pn=me.getParameter(L.UNPACK_ROW_LENGTH),Je=me.getParameter(L.UNPACK_IMAGE_HEIGHT),bn=me.getParameter(L.UNPACK_SKIP_PIXELS),Qn=me.getParameter(L.UNPACK_SKIP_ROWS),Oi=me.getParameter(L.UNPACK_SKIP_IMAGES);me.pixelStorei(L.UNPACK_ROW_LENGTH,Tt.width),me.pixelStorei(L.UNPACK_IMAGE_HEIGHT,Tt.height),me.pixelStorei(L.UNPACK_SKIP_PIXELS,Pe),me.pixelStorei(L.UNPACK_SKIP_ROWS,We),me.pixelStorei(L.UNPACK_SKIP_IMAGES,qe);const Xr=y.isDataArrayTexture||y.isData3DTexture,pt=N.isDataArrayTexture||N.isData3DTexture;if(y.isDepthTexture){const Rt=T.get(y),Bi=T.get(N),gt=T.get(Rt.__renderTarget),ki=T.get(Bi.__renderTarget);me.bindFramebuffer(L.READ_FRAMEBUFFER,gt.__webglFramebuffer),me.bindFramebuffer(L.DRAW_FRAMEBUFFER,ki.__webglFramebuffer);for(let jr=0;jr<be;jr++)Xr&&(L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,T.get(y).__webglTexture,H,qe+jr),L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,T.get(N).__webglTexture,xe,Ct+jr)),L.blitFramebuffer(Pe,We,Te,_e,De,ut,Te,_e,L.DEPTH_BUFFER_BIT,L.NEAREST);me.bindFramebuffer(L.READ_FRAMEBUFFER,null),me.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else if(H!==0||y.isRenderTargetTexture||T.has(y)){const Rt=T.get(y),Bi=T.get(N);me.bindFramebuffer(L.READ_FRAMEBUFFER,Uv),me.bindFramebuffer(L.DRAW_FRAMEBUFFER,Nv);for(let gt=0;gt<be;gt++)Xr?L.framebufferTextureLayer(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,Rt.__webglTexture,H,qe+gt):L.framebufferTexture2D(L.READ_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,Rt.__webglTexture,H),pt?L.framebufferTextureLayer(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,Bi.__webglTexture,xe,Ct+gt):L.framebufferTexture2D(L.DRAW_FRAMEBUFFER,L.COLOR_ATTACHMENT0,L.TEXTURE_2D,Bi.__webglTexture,xe),H!==0?L.blitFramebuffer(Pe,We,Te,_e,De,ut,Te,_e,L.COLOR_BUFFER_BIT,L.NEAREST):pt?L.copyTexSubImage3D(Ee,xe,De,ut,Ct+gt,Pe,We,Te,_e):L.copyTexSubImage2D(Ee,xe,De,ut,Pe,We,Te,_e);me.bindFramebuffer(L.READ_FRAMEBUFFER,null),me.bindFramebuffer(L.DRAW_FRAMEBUFFER,null)}else pt?y.isDataTexture||y.isData3DTexture?L.texSubImage3D(Ee,xe,De,ut,Ct,Te,_e,be,ht,jt,Tt.data):N.isCompressedArrayTexture?L.compressedTexSubImage3D(Ee,xe,De,ut,Ct,Te,_e,be,ht,Tt.data):L.texSubImage3D(Ee,xe,De,ut,Ct,Te,_e,be,ht,jt,Tt):y.isDataTexture?L.texSubImage2D(L.TEXTURE_2D,xe,De,ut,Te,_e,ht,jt,Tt.data):y.isCompressedTexture?L.compressedTexSubImage2D(L.TEXTURE_2D,xe,De,ut,Tt.width,Tt.height,ht,Tt.data):L.texSubImage2D(L.TEXTURE_2D,xe,De,ut,Te,_e,ht,jt,Tt);me.pixelStorei(L.UNPACK_ROW_LENGTH,pn),me.pixelStorei(L.UNPACK_IMAGE_HEIGHT,Je),me.pixelStorei(L.UNPACK_SKIP_PIXELS,bn),me.pixelStorei(L.UNPACK_SKIP_ROWS,Qn),me.pixelStorei(L.UNPACK_SKIP_IMAGES,Oi),xe===0&&N.generateMipmaps&&L.generateMipmap(Ee),me.unbindTexture()},this.initRenderTarget=function(y){T.get(y).__webglFramebuffer===void 0&&v.setupRenderTarget(y)},this.initTexture=function(y){y.isCubeTexture?v.setTextureCube(y,0):y.isData3DTexture?v.setTexture3D(y,0):y.isDataArrayTexture||y.isCompressedArrayTexture?v.setTexture2DArray(y,0):v.setTexture2D(y,0),me.unbindTexture()},this.resetState=function(){q=0,K=0,I=null,me.reset(),ce.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return oi}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const n=this.getContext();n.drawingBufferColorSpace=Ze._getDrawingBufferColorSpace(e),n.unpackColorSpace=Ze._getUnpackColorSpace()}}const th=Ie.createContext(null);th.displayName="WaterContext";function _w(){const t=Ie.useContext(th);if(!t)throw new Error("<WaterItem>, <Float>, <Submerged>, useWaterOverlay y useWaterItem deben usarse dentro de <WaterOverlay>.");return t}const uc=`
varying vec2 vUv;
void main() {
  vUv = uv;
...
}`;function vn(t){const e=Math.sqrt(t[0]**2+t[1]**2+t[2]**2);return[t[0]/e,t[1]/e,t[2]/e]}function ys([t,e,n]){const i=r=>Math.round(Math.max(0,Math.min(1,r))*255).toString(16).padStart(2,"0");return`#${i(t)}${i(e)}${i(n)}`}function Mw(t){const e=t.replace("#","").padEnd(6,"0"),n=parseInt(e,16);return[(n>>16&255)/255,(n>>8&255)/255,(n&255)/255]}function Em(t){if(!t)return null;if(/^#[0-9a-fA-F]{3,8}$/.test(t)){const o=t.length<=4?"#"+[...t.slice(1)].map(a=>a+a).join(""):t;return Mw(o)}if(typeof document>"u")return null;const e=document.createElement("canvas");e.width=e.height=1;const n=e.getContext("2d");if(!n)return null;n.fillStyle=t,n.fillRect(0,0,1,1);const[i,r,s]=n.getImageData(0,0,1,1).data;return[i/255,r/255,s/255]}const Dr={dawn:{lightDir:vn([.7,.2,.8]),lightColor:[1,.72,.45],waterColor:[.18,.04,.1],specularIntensity:2.2,glowIntensity:.4},noon:{lightDir:vn([.35,.55,1]),lightColor:[.75,.88,1],waterColor:[0,.04,.12],specularIntensity:3.5,glowIntensity:.2},neon:{lightDir:vn([.4,.4,1]),lightColor:[.2,1,.82],waterColor:[0,.12,.08],specularIntensity:5.5,glowIntensity:.9},fluorescent:{lightDir:vn([.05,.9,1]),lightColor:[.62,.82,.96],waterColor:[.01,.04,.16],specularIntensity:1.8,glowIntensity:.15}},qf=Dr.noon,Ew={low:{simResolution:256,dispRes:64,dispFreq:4},medium:{simResolution:384,dispRes:96,dispFreq:3},high:{simResolution:512,dispRes:128,dispFreq:2}};function Tw(){const t=navigator.hardwareConcurrency??4;return t<=2?"low":t<=4?"medium":"high"}function ww(t){return t?typeof t=="object"&&"x"in t?vn([t.x,t.y,t.z??1]):{top:vn([0,1,.8]),bottom:vn([0,-1,.8]),left:vn([-1,0,.8]),right:vn([1,0,.8]),"top-left":vn([-.7,.7,.8]),"top-right":vn([.7,.7,.8]),"bottom-left":vn([-.7,-.7,.8]),"bottom-right":vn([.7,-.7,.8])}[t]??qf.lightDir:qf.lightDir}function Aw(t,e){return Math.max(0,Math.min(1,t*e))}function Cw(t){return 1-t*.88}function Rw(t){return t*.72}const Cv=Ie.forwardRef(function(e,n){const{children:i,level:r=.7,mode:s="interactive",light:o,material:a,interaction:l,performance:u,layout:d,debug:h=!1,className:f,style:m}=e,_=Math.max(0,Math.min(1,r)),E=(()=>{const Ce=(u==null?void 0:u.quality)??"auto";return Ce==="auto"?Tw():Ce})(),{simResolution:g,dispRes:c,dispFreq:p}=Ew[E],S=(o==null?void 0:o.preset)??"noon",M=S!=="custom"?Dr[S]:qf,C=(o==null?void 0:o.direction)!=null?ww(o.direction):M.lightDir,w=Em(o==null?void 0:o.color)??M.lightColor,A=Em(a==null?void 0:a.tint)??M.waterColor,x=(a==null?void 0:a.opacity)??.1,R=((o==null?void 0:o.specular)??1)*M.specularIntensity,P=((o==null?void 0:o.glow)??1)*M.glowIntensity,b=(a==null?void 0:a.distortionScale)??1,k=(l==null?void 0:l.ripples)!==!1,q=(l==null?void 0:l.rippleStrength)??.9,K=(l==null?void 0:l.rippleRadius)??.028,I=Ie.useRef({distortionMult:b,lightDir:C,lightColor:w,waterColor:A,tintOpacity:x,specularIntensity:R,glowIntensity:P,depthScale:_});I.current={distortionMult:b,lightDir:C,lightColor:w,waterColor:A,tintOpacity:x,specularIntensity:R,glowIntensity:P,depthScale:_};const W=Ie.useRef(null),z=Ie.useRef(null),B=Ie.useRef(null),j=Ie.useRef(null),J=Ie.useRef(null),[,fe]=Ie.useReducer(Ce=>Ce+1,0),se=Ie.useRef([]),Le=Ie.useRef({rain:{active:!1,intensity:.5},sea:{active:!1,intensity:.5},vibration:{active:!1,strength:1,endTime:0},wave:{active:!1,dir:"right",strength:1,phase:0,total:240}}),Fe=`wo6-${Ie.useId().replace(/:/g,"")}`;Ie.useImperativeHandle(n,()=>({splash(Ce=window.innerWidth/2,Oe=window.innerHeight/2,Se=.9){se.current.push({x:Ce/window.innerWidth,y:1-Oe/window.innerHeight,strength:Se,radius:K})},rain(Ce=.5){const Oe=Le.current.rain;return Oe.active=!0,Oe.intensity=Math.max(0,Math.min(1,Ce)),()=>{Le.current.rain.active=!1}},sea(Ce=.5){const Oe=Le.current.sea;return Oe.active=!0,Oe.intensity=Math.max(0,Math.min(1,Ce)),()=>{Le.current.sea.active=!1}},trail(Ce,Oe,Se=.4){se.current.push({x:Ce/window.innerWidth,y:1-Oe/window.innerHeight,strength:Se,radius:K*.55})},vibration(Ce=1,Oe=1e3){const Se=Le.current.vibration;Se.active=!0,Se.strength=Math.max(0,Ce),Se.endTime=Date.now()+Oe},wave(Ce="right",Oe=1){const Se=Le.current.wave;Se.active=!0,Se.dir=Ce,Se.strength=Math.max(0,Oe),Se.phase=0,Se.total=240},stopEffects(){Le.current.rain.active=!1,Le.current.sea.active=!1,Le.current.vibration.active=!1,Le.current.wave.active=!1,se.current.length=0}}),[K]);const Z=Ie.useRef(!1),ae=Ie.useCallback(Ce=>{var Oe,Se;k&&((Se=(Oe=Ce.target).closest)!=null&&Se.call(Oe,"[data-water-surface]")||(Z.current=!0,se.current.push({x:Ce.clientX/window.innerWidth,y:1-Ce.clientY/window.innerHeight,strength:q,radius:K})))},[k,q,K]),de=Ie.useCallback(Ce=>{var Oe,Se;!k||!Z.current||(Se=(Oe=Ce.target).closest)!=null&&Se.call(Oe,"[data-water-surface]")||se.current.push({x:Ce.clientX/window.innerWidth,y:1-Ce.clientY/window.innerHeight,strength:q*.45,radius:K})},[k,q,K]),Ue=Ie.useCallback(()=>{Z.current=!1},[]);Ie.useEffect(()=>{const Ce=W.current,Oe=z.current,Se=j.current,ft=B.current;if(!Ce||!Oe||!Se||!ft)return;fe();const at=(Re,Me)=>{ft.setAttribute("x","0"),ft.setAttribute("y","0"),ft.setAttribute("width",String(Re)),ft.setAttribute("height",String(Me)),Se.setAttribute("x","0"),Se.setAttribute("y","0"),Se.setAttribute("width",String(Re)),Se.setAttribute("height",String(Me))};at(window.innerWidth,window.innerHeight);const rt=new vw({canvas:Ce,antialias:!1,alpha:!0,premultipliedAlpha:!0});rt.setPixelRatio(1),rt.setSize(window.innerWidth,window.innerHeight);const L=new nt(1/g,1/g),mt={minFilter:It,magFilter:It,format:Mn,type:di};let Be=new tn(g,g,mt),$e=new tn(g,g,mt);const me=new tn(c,c,{minFilter:It,magFilter:It,format:Mn,type:Sn}),dt=new Uint8Array(c*c*4),T=new Zo(2,2),v=new eh(-1,1,1,-1,0,1),O=new ty,Q=new hi(T,null);O.add(Q);const F=new wn({vertexShader:uc,fragmentShader:xw,uniforms:{tSim:{value:null},texelSize:{value:L},aspectRatio:{value:window.innerWidth/window.innerHeight},splashPos:{value:new nt(-10,-10)},splashStrength:{value:0},splashRadius:{value:K}},depthTest:!1,depthWrite:!1}),ne=new wn({vertexShader:uc,fragmentShader:Sw,uniforms:{tSim:{value:null},texelSize:{value:L},distortionMult:{value:I.current.distortionMult}},depthTest:!1,depthWrite:!1}),re=I.current,Y=new wn({vertexShader:uc,fragmentShader:yw,uniforms:{tSim:{value:null},texelSize:{value:L},lightDir:{value:new G(...re.lightDir)},lightColor:{value:new G(...re.lightColor)},tintColor:{value:new G(...re.waterColor)},tintOpacity:{value:re.tintOpacity},specularIntensity:{value:re.specularIntensity},glowIntensity:{value:re.glowIntensity},depthScale:{value:re.depthScale}},transparent:!0,depthTest:!1,depthWrite:!1,blending:G0,blendEquation:Zi,blendSrc:W0,blendDst:Rl}),ee=Oe.getContext("2d"),ge=()=>{const Re=window.innerWidth,Me=window.innerHeight;rt.setSize(Re,Me),F.uniforms.aspectRatio.value=Re/Me,at(Re,Me),Be.dispose(),$e.dispose(),Be=new tn(g,g,mt),$e=new tn(g,g,mt)};window.addEventListener("resize",ge);let ye=0,le=0;const ue=()=>{ye=requestAnimationFrame(ue),le++;const Re=I.current,Me=Le.current,je=se.current,D=Date.now();if(Me.rain.active){const $=Math.max(.5,Me.rain.intensity*25),pe=Math.round(60/$);le%Math.max(1,pe)===0&&je.push({x:Math.random(),y:.1+Math.random()*.8,strength:.1+Math.random()*.2,radius:.007+Math.random()*.01})}if(Me.sea.active){const $=4+Me.sea.intensity*8,pe=Math.max(2,Math.round(60/$));le%pe===0&&(je.push({x:Math.random(),y:Math.random(),strength:Me.sea.intensity*(.022+Math.random()*.04),radius:.04+Math.random()*.06}),je.push({x:Math.random(),y:Math.random(),strength:Me.sea.intensity*(.015+Math.random()*.03),radius:.06+Math.random()*.08}))}if(Me.vibration.active&&(D>Me.vibration.endTime?Me.vibration.active=!1:le%2===0&&je.push({x:Math.random(),y:Math.random(),strength:Me.vibration.strength*(.04+Math.random()*.09),radius:.018+Math.random()*.03})),Me.wave.active){if(Me.wave.phase++,Me.wave.phase>=Me.wave.total)Me.wave.active=!1;else if(Me.wave.phase%4===0){const $=Me.wave.phase/Me.wave.total,pe=Me.wave.dir,he=pe==="left"||pe==="right",ie=pe==="left"||pe==="top"?1.15-$*1.3:-.15+$*1.3;for(let Ae=0;Ae<=5;Ae++){const Ve=Ae/5;je.push({x:he?ie:Ve,y:he?Ve:ie,strength:Me.wave.strength*(.5+Math.random()*.12),radius:.082+Math.random()*.02})}}}const ce=Math.min(je.length,6);if(ce===0)F.uniforms.splashStrength.value=0,F.uniforms.tSim.value=Be.texture,Q.material=F,rt.setRenderTarget($e),rt.render(O,v),[Be,$e]=[$e,Be];else{for(let $=0;$<ce;$++){const pe=je.shift();F.uniforms.splashPos.value.set(pe.x,pe.y),F.uniforms.splashStrength.value=pe.strength,F.uniforms.splashRadius.value=pe.radius,F.uniforms.tSim.value=Be.texture,Q.material=F,rt.setRenderTarget($e),rt.render(O,v),[Be,$e]=[$e,Be]}F.uniforms.splashStrength.value=0}if(le%p===0){ne.uniforms.tSim.value=Be.texture,ne.uniforms.distortionMult.value=Re.distortionMult,Q.material=ne,rt.setRenderTarget(me),rt.render(O,v),rt.readRenderTargetPixels(me,0,0,c,c,dt);const $=ee.createImageData(c,c);$.data.set(dt),ee.putImageData($,0,0),Se.setAttributeNS("http://www.w3.org/1999/xlink","href",Oe.toDataURL())}Y.uniforms.tSim.value=Be.texture,Y.uniforms.lightDir.value.set(...Re.lightDir),Y.uniforms.lightColor.value.set(...Re.lightColor),Y.uniforms.tintColor.value.set(...Re.waterColor),Y.uniforms.tintOpacity.value=Re.tintOpacity,Y.uniforms.specularIntensity.value=Re.specularIntensity,Y.uniforms.glowIntensity.value=Re.glowIntensity,Y.uniforms.depthScale.value=Re.depthScale,Q.material=Y,rt.setRenderTarget(null),rt.render(O,v)};return ue(),()=>{cancelAnimationFrame(ye),window.removeEventListener("resize",ge),Be.dispose(),$e.dispose(),me.dispose(),F.dispose(),ne.dispose(),Y.dispose(),T.dispose(),rt.dispose()}},[g,c,p,K]);const ke=Ie.useCallback(Ce=>Aw(Ce,_),[_]),Ne={depthScale:_,mode:s,lightPreset:S,isInteractive:s==="interactive",darknessFor:ke,surfaceSlot:J.current},Xe=(d==null?void 0:d.strategy)!=="contained"?{position:"fixed",inset:0,overflow:(d==null?void 0:d.overflowClip)!==!1?"hidden":"visible",...m}:{position:"relative",width:"100%",height:"100%",overflow:"hidden",...m};return U.jsx(th.Provider,{value:Ne,children:U.jsxs("div",{className:f,style:Xe,onPointerDown:ae,onPointerMove:de,onPointerUp:Ue,onPointerLeave:Ue,children:[U.jsx("div",{style:{position:"absolute",inset:0,filter:`url(#${Fe})`,zIndex:1},children:i}),U.jsx("canvas",{ref:W,"data-ripple-ignore":"true",style:{position:"absolute",inset:0,width:"100%",height:"100%",display:"block",pointerEvents:"none",zIndex:9999}}),U.jsx("div",{ref:J,style:{position:"absolute",inset:0,pointerEvents:"none",zIndex:1e4}}),U.jsx("canvas",{ref:z,width:c,height:c,"data-ripple-ignore":"true",style:{display:"none"}}),U.jsx("svg",{width:"0",height:"0","data-ripple-ignore":"true",style:{position:"fixed",top:0,left:0,overflow:"hidden",pointerEvents:"none"},children:U.jsx("defs",{children:U.jsxs("filter",{ref:B,id:Fe,x:"0",y:"0",width:window.innerWidth,height:window.innerHeight,filterUnits:"userSpaceOnUse",colorInterpolationFilters:"sRGB",children:[U.jsx("feImage",{ref:j,preserveAspectRatio:"none",result:"disp"}),U.jsx("feDisplacementMap",{in:"SourceGraphic",in2:"disp",scale:"35",xChannelSelector:"R",yChannelSelector:"G"})]})})}),h&&U.jsxs("div",{style:{position:"absolute",top:8,left:8,zIndex:99999,fontFamily:"monospace",fontSize:11,color:"rgba(0,255,128,0.9)",background:"rgba(0,0,0,0.55)",padding:"4px 10px",borderRadius:4,pointerEvents:"none"},children:["WaterOverlay v6 · depthScale=",_.toFixed(2)," · quality=",E," · mode=",s]})]})})});Cv.displayName="WaterOverlay";function Tm(t){if(t<=.01)return{};const e=Cw(t),n=1-t*.5;return{filter:`brightness(${e.toFixed(3)}) saturate(${n.toFixed(3)})`}}function wm({darkness:t}){if(t<=.02)return null;const e=Rw(t);return U.jsx("div",{"aria-hidden":"true",style:{position:"absolute",inset:0,background:`rgba(0, 8, 28, ${e.toFixed(3)})`,pointerEvents:"none",borderRadius:"inherit",zIndex:1}})}function nh({children:t,behavior:e="auto",depth:n=0,className:i,style:r}){const{darknessFor:s,surfaceSlot:o}=_w(),a=s(n);return e==="float"||e==="fixed"?o?V0.createPortal(U.jsxs("div",{"data-water-surface":"true",className:i,style:{position:"absolute",inset:0,pointerEvents:"none",...Tm(a),...r},children:[t,U.jsx(wm,{darkness:a})]}),o):null:U.jsxs("div",{className:i,style:{position:"relative",...Tm(a),...r},children:[t,U.jsx(wm,{darkness:a})]})}function bw(t){return U.jsx(nh,{...t,behavior:"fixed"})}const te={bg:"#020c1a",panelBg:"rgba(3, 14, 30, 0.91)",panelBorder:"rgba(45, 120, 210, 0.20)",sectionLine:"rgba(45, 120, 210, 0.12)",accent:"#38c9b8",accentFaint:"rgba(56,201,184,0.18)",hi:"rgba(205,232,255,0.93)",mid:"rgba(135,188,240,0.62)",lo:"rgba(85,135,205,0.38)",code:"rgba(56,201,184,0.82)",sans:"Segoe UI, system-ui, sans-serif",mono:"Consolas, monospace",PANEL_W:400},Pw=[{id:"pool",name:"Piscina",emoji:"🏊",description:"bright · shallow · clear",accentColor:"#6ee3ff",highlightHex:"#6ee3ff",waterHex:"#0087c8",direction:"top",specular:2.5,glow:.8,level:.45,distortionScale:1.4,rippleStrength:1,rippleRadius:.025,bgGradient:"linear-gradient(175deg, #041e3c 0%, #012240 100%)",gridColor:"rgba(80,200,255,0.07)"},{id:"tropical",name:"Tropical",emoji:"🌴",description:"warm · turquoise · sunny",accentColor:"#00c88a",highlightHex:"#ffe078",waterHex:"#00a87a",direction:"top-right",specular:3.5,glow:.6,level:.5,distortionScale:1,rippleStrength:.8,rippleRadius:.03,bgGradient:"linear-gradient(175deg, #051a18 0%, #031410 100%)",gridColor:"rgba(80,220,160,0.065)"},{id:"deep",name:"Mar Profundo",emoji:"🌊",description:"dark · vast · bioluminescent",accentColor:"#2060ff",highlightHex:"#2060ff",waterHex:"#00030f",direction:"top",specular:1.8,glow:2,level:.95,distortionScale:2,rippleStrength:1.2,rippleRadius:.04,bgGradient:"linear-gradient(175deg, #000008 0%, #00000f 100%)",gridColor:"rgba(20,60,200,0.05)",autoEffect:t=>t.sea(.3)},{id:"toxic",name:"Toxic Waste",emoji:"☢️",description:"viscous · neon · corrosive",accentColor:"#80ff00",highlightHex:"#c8ff00",waterHex:"#0a1f00",direction:"top",specular:5,glow:1.6,level:.8,distortionScale:.5,rippleStrength:.35,rippleRadius:.045,bgGradient:"linear-gradient(175deg, #060d00 0%, #0a1200 100%)",gridColor:"rgba(100,255,0,0.055)"},{id:"blood",name:"Blood",emoji:"🩸",description:"thick · viscous · crimson",accentColor:"#cc2000",highlightHex:"#ff3000",waterHex:"#280000",direction:"top-right",specular:1.5,glow:.4,level:.88,distortionScale:.3,rippleStrength:.25,rippleRadius:.05,bgGradient:"linear-gradient(175deg, #0c0000 0%, #100000 100%)",gridColor:"rgba(200,20,0,0.045)"},{id:"pond",name:"Pond",emoji:"🐸",description:"murky · still · algae",accentColor:"#668833",highlightHex:"#88c050",waterHex:"#080f02",direction:"top-left",specular:1.2,glow:.25,level:.72,distortionScale:.9,rippleStrength:.6,rippleRadius:.035,bgGradient:"linear-gradient(175deg, #060e02 0%, #040a01 100%)",gridColor:"rgba(80,140,20,0.05)"},{id:"aquarium",name:"Aquarium",emoji:"🐠",description:"bright · precise · curated",accentColor:"#50c8e8",highlightHex:"#a0eeff",waterHex:"#001833",direction:"top",specular:3.2,glow:1,level:.6,distortionScale:1.6,rippleStrength:.7,rippleRadius:.018,bgGradient:"linear-gradient(175deg, #040f1e 0%, #050d1a 100%)",gridColor:"rgba(80,200,255,0.06)"}];function Dw({scenarios:t,activeId:e,onSelect:n}){const[i,r]=Ie.useState(!1),s=t.find(o=>o.id===e)??null;return U.jsxs("div",{style:{position:"relative"},children:[U.jsxs("button",{onClick:()=>r(o=>!o),onBlur:()=>setTimeout(()=>r(!1),160),style:{display:"flex",alignItems:"center",gap:"0.5rem",background:"rgba(3,12,28,0.82)",backdropFilter:"blur(16px)",WebkitBackdropFilter:"blur(16px)",border:`1px solid ${s?s.accentColor+"55":"rgba(50,120,210,0.22)"}`,borderRadius:8,padding:"6px 10px",cursor:"pointer",fontFamily:te.sans,width:220,transition:"border-color 0.15s"},children:[U.jsx("div",{style:{width:7,height:7,borderRadius:"50%",flexShrink:0,background:s?s.accentColor:te.lo,boxShadow:s?`0 0 6px ${s.accentColor}`:"none",transition:"all 0.2s"}}),U.jsx("span",{style:{flex:1,textAlign:"left",fontSize:"0.62rem",color:s?s.accentColor:te.lo,fontWeight:s?500:400,transition:"color 0.15s"},children:s?s.name:"· scenarios"}),s&&U.jsx("span",{style:{fontSize:"0.55rem",color:te.lo},children:s.emoji}),U.jsx("span",{style:{fontSize:"0.55rem",color:te.lo,transform:i?"rotate(180deg)":"none",transition:"transform 0.15s",display:"inline-block"},children:"▾"})]}),i&&U.jsx("div",{style:{position:"absolute",top:"calc(100% + 6px)",left:0,width:260,zIndex:2,background:"rgba(3,12,28,0.96)",backdropFilter:"blur(20px)",WebkitBackdropFilter:"blur(20px)",border:"1px solid rgba(45,120,210,0.22)",borderRadius:10,overflow:"hidden",boxShadow:"0 8px 40px rgba(0,0,0,0.55)"},children:t.map(o=>{const a=o.id===e;return U.jsxs("button",{onClick:()=>{n(o),r(!1)},style:{display:"flex",alignItems:"center",gap:"0.55rem",width:"100%",padding:"8px 10px",background:a?`${o.accentColor}12`:"transparent",border:"none",borderBottom:"1px solid rgba(45,120,210,0.10)",cursor:"pointer",textAlign:"left",transition:"background 0.12s",position:"relative",overflow:"hidden"},onMouseEnter:l=>{a||(l.currentTarget.style.background=`${o.accentColor}0e`)},onMouseLeave:l=>{l.currentTarget.style.background=a?`${o.accentColor}12`:"transparent"},children:[U.jsx("div",{style:{position:"absolute",left:0,top:0,bottom:0,width:2,background:a?o.accentColor:"transparent",transition:"background 0.12s"}}),U.jsx("span",{style:{fontSize:"0.9rem",flexShrink:0,marginLeft:6},children:o.emoji}),U.jsxs("div",{style:{flex:1,minWidth:0},children:[U.jsx("div",{style:{fontFamily:te.sans,fontSize:"0.62rem",fontWeight:500,color:a?o.accentColor:te.hi,transition:"color 0.12s"},children:o.name}),U.jsx("div",{style:{fontFamily:te.mono,fontSize:"0.48rem",color:te.lo,marginTop:1},children:o.description})]}),U.jsxs("div",{style:{display:"flex",gap:3,flexShrink:0},children:[U.jsx("div",{style:{width:12,height:12,borderRadius:3,background:o.highlightHex,border:"1px solid rgba(255,255,255,0.12)"}}),U.jsx("div",{style:{width:12,height:12,borderRadius:3,background:o.waterHex,border:"1px solid rgba(255,255,255,0.12)"}})]})]},o.id)})})]})}function yr({label:t,children:e}){return U.jsxs("div",{style:{borderTop:`1px solid ${te.sectionLine}`,paddingTop:"0.75rem",marginTop:"0.75rem"},children:[U.jsx("div",{style:{fontFamily:te.sans,fontSize:"0.52rem",letterSpacing:"0.18em",textTransform:"uppercase",color:te.accent,opacity:.8,marginBottom:"0.55rem"},children:t}),U.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"0.45rem"},children:e})]})}function xn({label:t,prop:e,children:n}){return U.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:"0.5rem"},children:[U.jsxs("div",{style:{display:"flex",flexDirection:"column",flexShrink:0},children:[U.jsx("span",{style:{fontFamily:te.sans,fontSize:"0.66rem",color:te.mid},children:t}),U.jsx("code",{style:{fontFamily:te.mono,fontSize:"0.54rem",color:te.lo},children:e})]}),U.jsx("div",{style:{display:"flex",alignItems:"center",gap:"0.4rem",flexShrink:0},children:n})]})}function Dn({label:t,prop:e,min:n,max:i,step:r=.01,value:s,onChange:o,fmt:a}){return U.jsxs(xn,{label:t,prop:e,children:[U.jsx("input",{type:"range",min:n,max:i,step:r,value:s,onChange:l=>o(parseFloat(l.target.value)),style:{width:100,accentColor:te.accent,cursor:"pointer"}}),U.jsx("code",{style:{fontFamily:te.mono,fontSize:"0.64rem",color:te.hi,minWidth:34,textAlign:"right"},children:a?a(s):s.toFixed(2)})]})}function Am({label:t,prop:e,options:n,value:i,onChange:r}){return U.jsx(xn,{label:t,prop:e,children:U.jsx("div",{style:{display:"flex",gap:"0.25rem",flexWrap:"wrap",justifyContent:"flex-end"},children:n.map(s=>{const o=s===i;return U.jsx("button",{onClick:()=>r(s),style:{fontFamily:te.sans,fontSize:"0.55rem",letterSpacing:"0.06em",textTransform:"uppercase",background:o?te.accent:"rgba(0,15,40,0.6)",color:o?te.bg:te.mid,border:`1px solid ${o?te.accent:"rgba(50,120,210,0.22)"}`,borderRadius:20,padding:"3px 9px",cursor:"pointer",transition:"all 0.15s"},children:s},s)})})})}function Cm({label:t,prop:e,value:n,onChange:i}){return U.jsx(xn,{label:t,prop:e,children:U.jsx("button",{onClick:()=>i(!n),style:{fontFamily:te.mono,fontSize:"0.64rem",background:n?te.accentFaint:"rgba(0,15,40,0.6)",color:n?te.accent:te.lo,border:`1px solid ${n?te.accent:"rgba(50,120,210,0.22)"}`,borderRadius:20,padding:"3px 16px",cursor:"pointer",transition:"all 0.15s"},children:n?"on":"off"})})}function ls({children:t,onClick:e,active:n,danger:i,style:r}){const s=i?"rgba(255,90,90,0.85)":te.accent,o=n?i?"rgba(255,60,60,0.18)":te.accentFaint:"rgba(0,15,40,0.6)";return U.jsx("button",{onClick:e,style:{fontFamily:te.mono,fontSize:"0.60rem",letterSpacing:"0.04em",background:o,color:n||i?s:te.mid,border:`1px solid ${n?s:i?"rgba(255,90,90,0.35)":"rgba(50,120,210,0.28)"}`,borderRadius:20,padding:"4px 12px",cursor:"pointer",transition:"all 0.15s",whiteSpace:"nowrap",...r},onMouseEnter:a=>{a.currentTarget.style.background=i?"rgba(255,60,60,0.28)":"rgba(56,201,184,0.25)",a.currentTarget.style.color=s,a.currentTarget.style.borderColor=s},onMouseLeave:a=>{a.currentTarget.style.background=o,a.currentTarget.style.color=n||i?s:te.mid,a.currentTarget.style.borderColor=n?s:i?"rgba(255,90,90,0.35)":"rgba(50,120,210,0.28)"},children:t})}const Lw=[["top-left","↖"],["top","↑"],["top-right","↗"],["left","←"],null,["right","→"],["bottom-left","↙"],["bottom","↓"],["bottom-right","↘"]];function Iw({value:t,onChange:e}){return U.jsx(xn,{label:"direction",prop:"light.direction",children:U.jsx("div",{style:{display:"grid",gridTemplateColumns:"repeat(3, 24px)",gap:2},children:Lw.map((n,i)=>{if(!n)return U.jsx("div",{style:{width:24,height:24,display:"flex",alignItems:"center",justifyContent:"center",color:te.lo,fontSize:"0.5rem"},children:"·"},i);const[r,s]=n,o=r===t;return U.jsx("button",{onClick:()=>e(r),style:{width:24,height:24,padding:0,cursor:"pointer",background:o?te.accentFaint:"rgba(0,15,40,0.55)",border:`1px solid ${o?te.accent:"rgba(50,120,210,0.20)"}`,borderRadius:4,color:o?te.accent:te.mid,fontFamily:te.mono,fontSize:"0.75rem",lineHeight:1,transition:"all 0.12s"},children:s},i)})})})}const Uw={dawn:"warm · golden hour",noon:"cool · daylight",neon:"cyberpunk · vivid",fluorescent:"clinical · pale"},Nw=["dawn","noon","neon","fluorescent"];function Ms({color:t,size:e=14}){return U.jsx("div",{style:{width:e,height:e,borderRadius:3,background:t,border:"1px solid rgba(255,255,255,0.13)",flexShrink:0}})}function Fw({value:t,highlightHex:e,waterHex:n,onSelect:i}){return U.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:3},children:[Nw.map(r=>{const s=r===t,o=Dr[r],a=ys(o.lightColor),l=ys(o.waterColor);return U.jsxs("button",{onClick:()=>i(r),style:{display:"flex",alignItems:"center",gap:"0.45rem",background:s?"rgba(56,201,184,0.09)":"rgba(0,12,32,0.55)",border:`1px solid ${s?"rgba(56,201,184,0.40)":"rgba(50,120,210,0.16)"}`,borderRadius:6,padding:"5px 8px",cursor:"pointer",transition:"all 0.12s",textAlign:"left",width:"100%"},children:[U.jsx("div",{style:{width:5,height:5,borderRadius:"50%",flexShrink:0,background:s?te.accent:"rgba(85,135,205,0.25)",transition:"background 0.12s"}}),U.jsx("span",{style:{fontFamily:te.mono,fontSize:"0.60rem",flexShrink:0,width:76,color:s?te.accent:te.mid},children:r}),U.jsx("span",{style:{fontFamily:te.sans,fontSize:"0.50rem",color:te.lo,flex:1,overflow:"hidden",whiteSpace:"nowrap"},children:Uw[r]}),U.jsxs("div",{style:{display:"flex",gap:3,alignItems:"center",flexShrink:0},children:[U.jsx(Ms,{color:a}),U.jsx(Ms,{color:l})]})]},r)}),t==="custom"&&U.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"0.45rem",background:"rgba(56,201,184,0.07)",border:"1px dashed rgba(56,201,184,0.35)",borderRadius:6,padding:"5px 8px"},children:[U.jsx("div",{style:{width:5,height:5,borderRadius:"50%",background:te.accent,flexShrink:0}}),U.jsx("span",{style:{fontFamily:te.mono,fontSize:"0.60rem",color:te.accent,flexShrink:0,width:76},children:"custom"}),U.jsx("span",{style:{fontFamily:te.sans,fontSize:"0.50rem",color:te.lo,flex:1},children:"modified"}),U.jsxs("div",{style:{display:"flex",gap:3,flexShrink:0},children:[U.jsx(Ms,{color:e}),U.jsx(Ms,{color:n})]})]})]})}function Rm({label:t,prop:e,value:n,onChange:i}){const r=Ie.useRef(null);return U.jsx(xn,{label:t,prop:e,children:U.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"0.45rem",cursor:"pointer"},onClick:()=>{var s;return(s=r.current)==null?void 0:s.click()},children:[U.jsx("div",{style:{width:20,height:20,borderRadius:4,background:n,border:"2px solid rgba(255,255,255,0.18)",flexShrink:0,boxShadow:`0 0 6px ${n}55`,transition:"box-shadow 0.15s"}}),U.jsx("code",{style:{fontFamily:te.mono,fontSize:"0.60rem",color:te.hi,userSelect:"none"},children:n}),U.jsx("input",{ref:r,type:"color",value:n,onChange:s=>i(s.target.value),style:{position:"absolute",opacity:0,width:0,height:0,pointerEvents:"none"}})]})})}function Ow({highlightHex:t,waterHex:e}){return U.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"0.5rem",background:"rgba(0,8,22,0.55)",border:"1px solid rgba(50,120,210,0.14)",borderRadius:6,padding:"6px 8px"},children:[U.jsx("span",{style:{fontFamily:te.sans,fontSize:"0.52rem",color:te.lo,flexShrink:0},children:"current set"}),U.jsx("div",{style:{flex:1}}),U.jsxs("div",{style:{display:"flex",alignItems:"center",gap:4},children:[U.jsx(Ms,{color:t,size:16}),U.jsx("span",{style:{fontFamily:te.sans,fontSize:"0.48rem",color:te.lo},children:"hi"})]}),U.jsxs("div",{style:{display:"flex",alignItems:"center",gap:4},children:[U.jsx(Ms,{color:e,size:16}),U.jsx("span",{style:{fontFamily:te.sans,fontSize:"0.48rem",color:te.lo},children:"water"})]})]})}function Bw({level:t,mode:e,preset:n,lightDir:i,specular:r,glow:s,highlightHex:o,waterHex:a,distortionScale:l,ripples:u,rippleStrength:d,rippleRadius:h,quality:f,debug:m,itemDepth:_}){const E=typeof i=="string"?`"${i}"`:`{x:${i.x}}`,g=["<WaterOverlay",`  level={${t.toFixed(2)}}`,`  mode="${e}"`,`  debug={${m}}`,"  light={{",`    preset: "${n}",`,`    direction: ${E},`,`    specular: ${r.toFixed(2)},`,`    glow: ${s.toFixed(2)},`,`    color: "${o}",`,"  }}","  material={{",`    distortionScale: ${l.toFixed(2)},`,`    tint: "${a}",`,"  }}","  interaction={{",`    ripples: ${u},`,`    rippleStrength: ${d.toFixed(2)},`,`    rippleRadius: ${h.toFixed(3)},`,"  }}",`  performance={{ quality: "${f}" }}`,">",`  <WaterItem depth={${_.toFixed(2)}}>`,"    {/* submerged content */}","  </WaterItem>","  <Float>{/* surface UI */}</Float>","</WaterOverlay>"];return U.jsxs("div",{style:{borderTop:`1px solid ${te.sectionLine}`,paddingTop:"0.75rem",marginTop:"0.75rem"},children:[U.jsx("div",{style:{fontFamily:te.sans,fontSize:"0.52rem",letterSpacing:"0.18em",textTransform:"uppercase",color:te.accent,opacity:.8,marginBottom:"0.5rem"},children:"live code"}),U.jsx("pre",{style:{fontFamily:te.mono,fontSize:"0.57rem",lineHeight:1.6,color:te.mid,background:"rgba(0,8,20,0.6)",border:`1px solid ${te.sectionLine}`,borderRadius:6,padding:"0.6rem 0.7rem",overflowX:"auto",margin:0,whiteSpace:"pre"},children:g.map((c,p)=>U.jsx("span",{style:{display:"block"},children:c.split(/(["'][^"']*["']|{[^}]*}|\d+\.\d+|true|false)/g).map((S,M)=>{const C=/^["']/.test(S),w=/^\d+\.\d+$/.test(S)||S==="true"||S==="false";return U.jsx("span",{style:{color:C?"rgba(200,160,100,0.85)":w?"rgba(130,210,180,0.85)":te.mid},children:S},M)})},p))})]})}function cc({depth:t,label:e}){return U.jsx(nh,{depth:t,style:{flex:"1 1 140px",maxWidth:200},children:U.jsxs("div",{style:{background:"rgba(0,30,70,0.65)",border:"1px solid rgba(60,140,255,0.22)",borderRadius:12,padding:"1rem 1.1rem",display:"flex",flexDirection:"column",gap:"0.5rem"},children:[U.jsx("span",{style:{fontFamily:te.sans,fontSize:"0.56rem",letterSpacing:"0.14em",textTransform:"uppercase",color:te.accent,opacity:.75},children:e}),U.jsx("div",{style:{fontFamily:te.mono,fontSize:"1.8rem",fontWeight:700,color:`rgba(200,230,255,${.15+(1-t)*.7})`,lineHeight:1},children:t.toFixed(2)}),U.jsxs("div",{style:{fontFamily:te.sans,fontSize:"0.62rem",color:te.mid},children:["depth = ",t.toFixed(2)]}),U.jsx("div",{style:{width:"100%",height:3,background:"rgba(255,255,255,0.06)",borderRadius:2},children:U.jsx("div",{style:{width:`${t*100}%`,height:"100%",borderRadius:2,background:`rgba(56,201,184,${.25+t*.6})`}})})]})})}function kw(){const t=Ie.useRef(null),[e,n]=Ie.useState(.7),[i,r]=Ie.useState("interactive"),[s,o]=Ie.useState(!1),[a,l]=Ie.useState("noon"),[u,d]=Ie.useState("top"),[h,f]=Ie.useState(1),[m,_]=Ie.useState(1),[E,g]=Ie.useState(()=>ys(Dr.noon.lightColor)),[c,p]=Ie.useState(()=>ys(Dr.noon.waterColor)),S=F=>{l(F),g(ys(Dr[F].lightColor)),p(ys(Dr[F].waterColor))},M=F=>{g(F),l("custom")},C=F=>{p(F),l("custom")},[w,A]=Ie.useState(1),[x,R]=Ie.useState(!0),[P,b]=Ie.useState(.9),[k,q]=Ie.useState(.028),[K,I]=Ie.useState("high"),[W,z]=Ie.useState(.5),[B,j]=Ie.useState(!1),[J,fe]=Ie.useState(.5),se=Ie.useRef(null),[Le,He]=Ie.useState(!1),[Fe,Z]=Ie.useState(.5),ae=Ie.useRef(null),[de,Ue]=Ie.useState(1),[ke,Ne]=Ie.useState(1e3),[it,Xe]=Ie.useState("right"),[Ce,Oe]=Ie.useState(1),[Se,ft]=Ie.useState(!1),at=()=>{var F,ne;B?((F=se.current)==null||F.call(se),se.current=null,j(!1)):(se.current=((ne=t.current)==null?void 0:ne.rain(J))??null,j(!0))},rt=F=>{var ne,re;fe(F),B&&((ne=se.current)==null||ne.call(se),se.current=((re=t.current)==null?void 0:re.rain(F))??null)},L=()=>{var F,ne;Le?((F=ae.current)==null||F.call(ae),ae.current=null,He(!1)):(ae.current=((ne=t.current)==null?void 0:ne.sea(Fe))??null,He(!0))},mt=F=>{var ne,re;Z(F),Le&&((ne=ae.current)==null||ne.call(ae),ae.current=((re=t.current)==null?void 0:re.sea(F))??null)},[Be,$e]=Ie.useState(null),[me,dt]=Ie.useState(`linear-gradient(175deg, #071428 0%, ${te.bg} 100%)`),[T,v]=Ie.useState("rgba(100,165,255,0.055)"),O=F=>{var ne;(ne=t.current)==null||ne.stopEffects(),se.current=null,ae.current=null,j(!1),He(!1),g(F.highlightHex),p(F.waterHex),l("custom"),d(F.direction),f(F.specular),_(F.glow),n(F.level),A(F.distortionScale),b(F.rippleStrength),q(F.rippleRadius),dt(F.bgGradient),v(F.gridColor),$e(F.id),F.autoEffect&&(setTimeout(()=>{t.current&&F.autoEffect(t.current)},120),F.id==="deep"&&(ae.current=null,He(!0)))},Q={position:"absolute",top:0,right:0,width:te.PANEL_W,height:"100%",background:te.panelBg,backdropFilter:"blur(22px)",WebkitBackdropFilter:"blur(22px)",borderLeft:`1px solid ${te.panelBorder}`,overflowY:"auto",overflowX:"hidden",boxSizing:"border-box",padding:"1rem 1rem 2rem",pointerEvents:"auto"};return U.jsxs(Cv,{ref:t,level:e,mode:i,debug:s,light:{preset:a,direction:u,specular:h,glow:m,color:E},material:{distortionScale:w,tint:c},interaction:{ripples:x,rippleStrength:P,rippleRadius:k},performance:{quality:K},children:[U.jsxs("div",{style:{position:"absolute",inset:0,background:me,cursor:Se?"crosshair":"default",transition:"background 0.6s ease"},onPointerMove:Se?F=>{var ne;return(ne=t.current)==null?void 0:ne.trail(F.clientX,F.clientY)}:void 0,children:[U.jsx("div",{style:{position:"absolute",inset:0,pointerEvents:"none",backgroundImage:`
            linear-gradient(${T} 1px, transparent 1px),
            linear-gradient(90deg, ${T} 1px, transparent 1px)
          `,backgroundSize:"36px 36px"}}),U.jsxs("div",{style:{position:"absolute",inset:0,display:"flex",alignItems:"center",justifyContent:"center",paddingRight:te.PANEL_W+16,paddingLeft:24,boxSizing:"border-box",flexDirection:"column",gap:"1.5rem"},children:[U.jsxs("div",{style:{display:"flex",gap:"0.85rem",flexWrap:"wrap",justifyContent:"center"},children:[U.jsx(cc,{depth:0,label:"Surface"}),U.jsx(cc,{depth:.45,label:"Mid"}),U.jsx(cc,{depth:.9,label:"Deep"})]}),U.jsx(nh,{depth:W,style:{width:"100%",maxWidth:430},children:U.jsxs("div",{style:{background:"rgba(0,20,55,0.72)",border:"1px solid rgba(56,201,184,0.20)",borderRadius:12,padding:"1.1rem 1.3rem",display:"flex",flexDirection:"column",gap:"0.6rem"},children:[U.jsxs("div",{style:{display:"flex",alignItems:"center",justifyContent:"space-between"},children:[U.jsx("span",{style:{fontFamily:te.sans,fontSize:"0.56rem",letterSpacing:"0.14em",textTransform:"uppercase",color:te.accent,opacity:.75},children:"interactive depth"}),U.jsxs("code",{style:{fontFamily:te.mono,fontSize:"0.62rem",color:te.hi},children:["depth=",W.toFixed(2)]})]}),U.jsxs("p",{style:{fontFamily:te.sans,fontSize:"0.70rem",color:te.mid,margin:0,lineHeight:1.6},children:["Este elemento usa el prop ",U.jsx("code",{style:{color:te.code,fontFamily:te.mono},children:"depth"})," de"," ",U.jsx("code",{style:{color:te.code,fontFamily:te.mono},children:"<WaterItem>"}),". Controla su oscurecimiento en el eje Z del agua."]}),U.jsx("div",{style:{width:"100%",height:3,background:"rgba(255,255,255,0.06)",borderRadius:2,overflow:"hidden"},children:U.jsx("div",{style:{width:`${W*100}%`,height:"100%",background:`rgba(56,201,184,${.4+W*.55})`,transition:"width 0.05s",borderRadius:2}})})]})})]}),U.jsx("div",{style:{position:"absolute",bottom:"1.2rem",left:"50%",transform:`translateX(calc(-50% - ${te.PANEL_W/2}px))`,fontFamily:te.sans,fontSize:"0.58rem",letterSpacing:"0.12em",color:te.lo,userSelect:"none",textTransform:"uppercase"},children:"click · drag · touch to create ripples"})]}),U.jsxs(bw,{children:[U.jsxs("div",{style:{position:"absolute",top:"1.6rem",left:"1.6rem",pointerEvents:"none"},children:[U.jsx("p",{style:{fontFamily:te.sans,fontSize:"0.55rem",letterSpacing:"0.18em",textTransform:"uppercase",color:te.lo,margin:"0 0 0.3rem"},children:"ripple / v6"}),U.jsx("h1",{style:{fontFamily:te.sans,fontSize:"clamp(1.2rem,2.5vw,2rem)",fontWeight:200,letterSpacing:"0.06em",color:te.hi,margin:0,textShadow:"0 0 40px rgba(50,175,255,0.30)"},children:"WaterOverlay"})]}),U.jsx("div",{style:{position:"absolute",top:"5.6rem",left:"1.6rem",pointerEvents:"auto",zIndex:1},children:U.jsx(Dw,{scenarios:Pw,activeId:Be,onSelect:O})}),U.jsxs("div",{style:Q,children:[U.jsxs("div",{style:{marginBottom:"0.5rem"},children:[U.jsx("p",{style:{fontFamily:te.sans,fontSize:"0.50rem",letterSpacing:"0.18em",textTransform:"uppercase",color:te.lo,margin:"0 0 0.2rem"},children:"api explorer"}),U.jsx("p",{style:{fontFamily:te.mono,fontSize:"0.70rem",color:te.accent,margin:0},children:"WaterOverlay v6"})]}),U.jsxs(yr,{label:"Global",children:[U.jsx(Dn,{label:"depth scale",prop:"level",min:0,max:1,value:e,onChange:n}),U.jsx(Am,{label:"mode",prop:"mode",options:["interactive","static"],value:i,onChange:r}),U.jsx(Cm,{label:"debug HUD",prop:"debug",value:s,onChange:o})]}),U.jsxs(yr,{label:"Light",children:[U.jsx(Ow,{highlightHex:E,waterHex:c}),U.jsx("div",{style:{fontFamily:te.sans,fontSize:"0.50rem",color:te.lo,letterSpacing:"0.10em",marginTop:"0.15rem",marginBottom:"0.1rem"},children:"presets"}),U.jsx(Fw,{value:a,highlightHex:E,waterHex:c,onSelect:S}),U.jsx("div",{style:{fontFamily:te.sans,fontSize:"0.50rem",color:te.lo,letterSpacing:"0.10em",marginTop:"0.35rem",marginBottom:"0.1rem"},children:"custom colors"}),U.jsx(Rm,{label:"highlight",prop:"light.color",value:E,onChange:M}),U.jsx(Rm,{label:"water body",prop:"material.tint",value:c,onChange:C}),U.jsx("div",{style:{fontFamily:te.sans,fontSize:"0.50rem",color:te.lo,letterSpacing:"0.10em",marginTop:"0.35rem",marginBottom:"0.1rem"},children:"direction & intensity"}),U.jsx(Iw,{value:u,onChange:d}),U.jsx(Dn,{label:"specular",prop:"light.specular",min:0,max:3,value:h,onChange:f}),U.jsx(Dn,{label:"glow",prop:"light.glow",min:0,max:3,value:m,onChange:_})]}),U.jsx(yr,{label:"Material",children:U.jsx(Dn,{label:"distortion",prop:"material.distortionScale",min:0,max:3,value:w,onChange:A})}),U.jsxs(yr,{label:"Interaction",children:[U.jsx(Cm,{label:"ripples",prop:"interaction.ripples",value:x,onChange:R}),U.jsx(Dn,{label:"strength",prop:"interaction.rippleStrength",min:0,max:2,value:P,onChange:b}),U.jsx(Dn,{label:"radius",prop:"interaction.rippleRadius",min:.005,max:.08,step:.001,value:k,onChange:q,fmt:F=>F.toFixed(3)})]}),U.jsx(yr,{label:"Performance",children:U.jsx(Am,{label:"quality",prop:"performance.quality",options:["auto","low","medium","high"],value:K,onChange:I})}),U.jsx(yr,{label:"WaterItem",children:U.jsx(Dn,{label:"depth",prop:"<WaterItem depth>",min:0,max:1,value:W,onChange:z})}),U.jsxs(yr,{label:"Handle",children:[U.jsx(xn,{label:"single ripple",prop:"ref.splash()",children:U.jsx(ls,{onClick:()=>{var F;return(F=t.current)==null?void 0:F.splash()},children:"◎ splash"})}),U.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"0.35rem"},children:[U.jsx(Dn,{label:"rain intensity",prop:"ref.rain(intensity)",min:.05,max:1,step:.01,value:J,onChange:rt}),U.jsx(xn,{label:"",prop:"",children:U.jsx(ls,{active:B,onClick:at,style:{minWidth:96},children:B?"■ stop rain":"▼ start rain"})})]}),U.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"0.35rem"},children:[U.jsx(Dn,{label:"sea intensity",prop:"ref.sea(intensity)",min:.05,max:1,step:.01,value:Fe,onChange:mt}),U.jsx(xn,{label:"",prop:"",children:U.jsx(ls,{active:Le,onClick:L,style:{minWidth:96},children:Le?"■ calm sea":"≋ start sea"})})]}),U.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"0.35rem"},children:[U.jsx(Dn,{label:"vib strength",prop:"ref.vibration(strength)",min:0,max:2,value:de,onChange:Ue}),U.jsx(Dn,{label:"vib duration",prop:"ref.vibration(_, ms)",min:200,max:4e3,step:100,value:ke,onChange:Ne,fmt:F=>`${Math.round(F)}ms`}),U.jsx(xn,{label:"",prop:"",children:U.jsx(ls,{onClick:()=>{var F;return(F=t.current)==null?void 0:F.vibration(de,ke)},children:"⚡ vibrate"})})]}),U.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"0.35rem"},children:[U.jsx(Dn,{label:"wavefront",prop:"ref.wave(dir, strength)",min:0,max:2,value:Ce,onChange:Oe}),U.jsx(xn,{label:"origin",prop:"ref.wave(direction)",children:U.jsx("div",{style:{display:"flex",gap:3},children:["left","right","top","bottom"].map(F=>{const ne=F==="left"?"←":F==="right"?"→":F==="top"?"↑":"↓";return U.jsx("button",{onClick:()=>Xe(F),style:{width:24,height:24,padding:0,cursor:"pointer",background:it===F?te.accentFaint:"rgba(0,15,40,0.55)",border:`1px solid ${it===F?te.accent:"rgba(50,120,210,0.20)"}`,borderRadius:4,color:it===F?te.accent:te.mid,fontFamily:te.mono,fontSize:"0.75rem",lineHeight:1,transition:"all 0.12s"},children:ne},F)})})}),U.jsx(xn,{label:"",prop:"",children:U.jsx(ls,{onClick:()=>{var F;return(F=t.current)==null?void 0:F.wave(it,Ce)},children:"〰 launch wave"})})]}),U.jsx(xn,{label:"hover trail",prop:"ref.trail(x, y)",children:U.jsx("button",{onClick:()=>ft(F=>!F),style:{fontFamily:te.mono,fontSize:"0.64rem",background:Se?te.accentFaint:"rgba(0,15,40,0.6)",color:Se?te.accent:te.lo,border:`1px solid ${Se?te.accent:"rgba(50,120,210,0.22)"}`,borderRadius:20,padding:"3px 16px",cursor:"pointer",transition:"all 0.15s"},children:Se?"● on":"○ off"})}),Se&&U.jsx("div",{style:{fontFamily:te.sans,fontSize:"0.52rem",color:te.lo,fontStyle:"italic",paddingLeft:"0.5rem"},children:"move cursor over the scene to draw"}),U.jsx(xn,{label:"stop all",prop:"ref.stopEffects()",children:U.jsx(ls,{onClick:()=>{var F;(F=t.current)==null||F.stopEffects(),se.current=null,ae.current=null,j(!1),He(!1)},danger:!0,children:"✕ stop all"})})]}),U.jsx(Bw,{level:e,mode:i,preset:a,lightDir:u,specular:h,glow:m,highlightHex:E,waterHex:c,distortionScale:w,ripples:x,rippleStrength:P,rippleRadius:k,quality:K,debug:s,itemDepth:W})]})]})]})}function zw(){return U.jsx(kw,{})}H0(document.getElementById("root")).render(U.jsx(Ie.StrictMode,{children:U.jsx(zw,{})}));
